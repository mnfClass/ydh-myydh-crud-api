...
## [10.0.0](https://github.com/mnfClass/ydh-myydh-crud-api/compare/v9.0.7...v10.0.0) (2022-09-16)
...
* **routes/admin/access:** add `location` header to 201 responses ([#711](https://github.com/mnfClass/ydh-myydh-crud-api/issues/711)) ([f78de1e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f78de1e0b5f54420095e848f527528f8b93babc8))
* **routes/admin:** add access route ([6a4332c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6a4332c4fd83d174380938441bcac32c23915d61))
* **routes:** support `application/xml` responses ([#670](https://github.com/mnfClass/ydh-myydh-crud-api/issues/670)) ([bf1d952](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bf1d952f237caa5d03e58c603e45e4f5a68e6f85))


### Bug Fixes

* **admin/access:** searching using `access.scopes` ([0bfa647](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0bfa6477f1bfd3d29f9b34b9b511a1883ca0e889))
* **config:** `default` throws exceptions when used in `anyOf` schemas ([e484456](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e484456e23dcf7a26e9641fe96e5d2e102ba2413))
* **config:** enforce minimum length for `ADMIN_PASSWORD` env variable ([bf93742](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bf93742d67ecf6d58db3b6009dcb630c1c42c604))
* **config:** log rotation max files ([#933](https://github.com/mnfClass/ydh-myydh-crud-api/issues/933)) ([c0661bf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c0661bfb5fd745bc0118b7035d14f5da1cc70bd0))
* **config:** redact request auth header from logs ([72249fd](https://github.com/mnfClass/ydh-myydh-crud-api/commit/72249fda1378bf7a1105eeaca56ba94d5921fcca))
* **config:** use `HOST` and `PORT` env variables for cloud services ([68c36f6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/68c36f6378f5f9260ec0b5c0d1cb8b6f99c662da))
* **docker-compose:** declare `DB_CLIENT` env variable ([e262791](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e2627912986d78af63289b6988490b0a7539cf90))
* **document/register/schema:** expand datetime search pattern ([65f8274](https://github.com/mnfClass/ydh-myydh-crud-api/commit/65f82740eaaba1b5f95d27f27e158b8cfb184d7a))
* log error stack trace; adjust http 500 error responses ([#786](https://github.com/mnfClass/ydh-myydh-crud-api/issues/786)) ([bb19350](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bb19350324afd4785e9ebfe82b13bf163b2a515e))
* **migrations:** datetime with timezone data types now used ([52feaaa](https://github.com/mnfClass/ydh-myydh-crud-api/commit/52feaaaff7b86eca277e5f1a4c3362233c21fb4a))
* **plugins/hashed-bearer-auth:** log client name ([6484723](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6484723e40a1b208e4d13538d4ac9442c21d48e8))
* **plugins/serialize-json-to-xml:** 204 resps do not have content types ([f1815fe](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f1815febda43f69fbb8bf18d2c419502158e1aba))
* **plugins/serialize-json-to-xml:** ignore swagger and openapi specs ([#887](https://github.com/mnfClass/ydh-myydh-crud-api/issues/887)) ([f836b0f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f836b0f148275637ba03fb732e48fcfbd1b608f1))
* **plugins/shared-schemas:** replace 500 response message const ([cddf1da](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cddf1da9505de3cc3b82682b805e11fca6eb8a15))
* **plugins/shared-schemas:** use `examples` not `enum` for 404 responses ([3e20854](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3e20854976b7abf18343bc674d93ccfa825aab00))
* **public/docs:** add x-ua-compatible meta tag ([8a5effe](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8a5effef3dd63fff0ae67bdd353e9d8984688010))
* **routes/admin/access/bearer-token:** missing record url path ([e0e9b67](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e0e9b6773c975171f62385928c8da61e8a044c17))
* **routes/docs/json:** add cors support ([#736](https://github.com/mnfClass/ydh-myydh-crud-api/issues/736)) ([8795e77](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8795e7704f7cc4e5a17d92992a1520db1176a297))
* **routes/docs:** add ie unsupported script ([403b99e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/403b99e586fd8f9edbedd1f32f976a26e039f026))
* **routes/docs:** resolve cwe-676 ([0b5047b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0b5047b5ae44cd5526d955b35e186513b363a313))
* **routes:** datetime search params require timezone if time provided ([1d14735](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1d14735de32da479347c4094422d786964f0922d))
* **routes:** invalid openapi shared schema definitions ([#929](https://github.com/mnfClass/ydh-myydh-crud-api/issues/929)) ([d4ce95c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d4ce95cb1b665efadaa4e4b4b59172cd5b04c9ed))
* **routes:** pagination count returning as string for postgres conns ([#886](https://github.com/mnfClass/ydh-myydh-crud-api/issues/886)) ([a4bbaa6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a4bbaa60706ab9b35403a0db8d814ead18ec6486))
* **routes:** time and timezone suffix are case-sensitive ([18e5251](https://github.com/mnfClass/ydh-myydh-crud-api/commit/18e525108fc53ba60b8ca29220116c0206c1cdbb))
* **routes:** timestamptz data type does not support `YYYY` patterns ([41a07c6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/41a07c6ab95ac2a707eae93b6a4ace9e156e6e91))
* **server:** disable cache for all routes besides documentation ([89f4e43](https://github.com/mnfClass/ydh-myydh-crud-api/commit/89f4e43a59c3c45a6f2f0229bddeebb2824568a1))
* **server:** do not transform 503 http err into 500 http err response ([0278102](https://github.com/mnfClass/ydh-myydh-crud-api/commit/02781027bba80994293da2e664949331d24a05d3))
* **server:** enable xml serialisation api-wide; fix missing route elem ([bb3d839](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bb3d8395351c105b546a2bf0077d8a5fcaca381a))
* **server:** reduce `content-security-policy` for options routes ([#931](https://github.com/mnfClass/ydh-myydh-crud-api/issues/931)) ([4f793ce](https://github.com/mnfClass/ydh-myydh-crud-api/commit/4f793cedb3e94b5c78e14f99326fe4bf7fd7aa0c))
* stop npm from swallowing exit signals; run migrations on launch ([c152909](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c1529092652afbeec333e0507c69fe9ce5653b4b))


### Documentation

* improve readability ([3e54cca](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3e54cca1df62c8fc7c46d667435f74a49d12c137))
* **readme:** add mention of insomnia example requests ([6bc9499](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6bc94998b724347a9db93991f2cd067861272401))
* **readme:** grammar fixes ([fec30f2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/fec30f248086721739eb256a1814a3902f10a4c2))
* **readme:** move api docs access to usage section ([ae050a7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ae050a70b58851721be89eeaa3c4d9a01df7f297))
* **readme:** remove `db:migrate` step, now runs on start of api ([bce2bf3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bce2bf355311d9160416a5c84519fdfe87ad37fe))
* **readme:** remove snyk badge ([bea3ec4](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bea3ec4426c824fe7de122b5eaa2a2a52c31415e))
* **readme:** update min version of node, mssql, and postgres ([297715e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/297715ec9a1c660fddf3b543b970c319c2fac619))
* **readme:** update minimum node version required ([b95f547](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b95f547bc9f33e796554bf6f129cd76e067630d5))
* **readme:** use block quotes for notes to enable github md highlights ([3e42ebb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3e42ebb15b2121f69a5d34636ed88eff836e6ab3))
* update deployment steps to use `npm ci` ([2a25e2b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2a25e2bb3b4a99aa5d47d55997ade835bb059b2b))


### Dependencies

* **dependabot:** increase `open-pull-requests-limit` from 5 to 20 ([bb8e006](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bb8e0063ab401ac4433d9c8c44a0a1ffbbb87fdd))
* **deps-dev:** add missing caret range for prettier ([bc719b9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bc719b98d2910292c186c711145aca775dfc9e68))
* **deps-dev:** bump @commitlint/cli from 16.2.1 to 16.2.3 ([431123e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/431123e8f6ac0d9088e5e9c32109b9f8fa2bdd75))
* **deps-dev:** bump @commitlint/cli from 16.2.3 to 16.2.4 ([#801](https://github.com/mnfClass/ydh-myydh-crud-api/issues/801)) ([c883f33](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c883f33b974057db218123bac6b6fef93d5b4175))
* **deps-dev:** bump @commitlint/cli from 16.2.4 to 17.0.0 ([#830](https://github.com/mnfClass/ydh-myydh-crud-api/issues/830)) ([9bd7a6b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9bd7a6b5b2231579f2082bd44948cb98af980661))
* **deps-dev:** bump @commitlint/cli from 17.0.0 to 17.0.2 ([#846](https://github.com/mnfClass/ydh-myydh-crud-api/issues/846)) ([9041474](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9041474f0d12aabc88e4ef3ee203e464ca5d5bf4))
* **deps-dev:** bump @commitlint/cli from 17.0.2 to 17.0.3 ([#902](https://github.com/mnfClass/ydh-myydh-crud-api/issues/902)) ([86b6c16](https://github.com/mnfClass/ydh-myydh-crud-api/commit/86b6c16cabb7385367523efdb3fb00dd86374e1a))
* **deps-dev:** bump @commitlint/cli from 17.0.3 to 17.1.2 ([#978](https://github.com/mnfClass/ydh-myydh-crud-api/issues/978)) ([b305c4a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b305c4aa40274d56e79ab86e51310bb47e49e81f))
* **deps-dev:** bump @commitlint/config-conventional ([#797](https://github.com/mnfClass/ydh-myydh-crud-api/issues/797)) ([b0068b6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b0068b6f7edb2383d9af6a01ec99a2951dd07db1))
* **deps-dev:** bump @commitlint/config-conventional ([#831](https://github.com/mnfClass/ydh-myydh-crud-api/issues/831)) ([45a7727](https://github.com/mnfClass/ydh-myydh-crud-api/commit/45a7727b4296bb605db8713bf1795e1e4c53ffe4))
* **deps-dev:** bump @commitlint/config-conventional ([#851](https://github.com/mnfClass/ydh-myydh-crud-api/issues/851)) ([d9137b8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d9137b8aa989b2341b2926f9b37c6d57fe9ea492))
* **deps-dev:** bump @commitlint/config-conventional ([#900](https://github.com/mnfClass/ydh-myydh-crud-api/issues/900)) ([106979c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/106979cba26b83bee988dd56af1d72fa1d37d9c2))
* **deps-dev:** bump @commitlint/config-conventional ([#973](https://github.com/mnfClass/ydh-myydh-crud-api/issues/973)) ([7f391b2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7f391b2d74d4436719f6b20f32aa9c31080cbab0))
* **deps-dev:** bump @faker-js/faker from 6.0.0 to 6.1.1 ([cc68f57](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cc68f574cfa86691b8a81cb19d8f33018c2ebc2f))
* **deps-dev:** bump @faker-js/faker from 6.1.1 to 6.1.2 ([#764](https://github.com/mnfClass/ydh-myydh-crud-api/issues/764)) ([870dd68](https://github.com/mnfClass/ydh-myydh-crud-api/commit/870dd689656d84297c97457fb84267fb7a56bbf9))
* **deps-dev:** bump @faker-js/faker from 6.1.2 to 6.2.0 ([#792](https://github.com/mnfClass/ydh-myydh-crud-api/issues/792)) ([5679539](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5679539cdb743e5f562c581e61f2578be0f10601))
* **deps-dev:** bump @faker-js/faker from 6.2.0 to 6.3.1 ([#804](https://github.com/mnfClass/ydh-myydh-crud-api/issues/804)) ([c711688](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c7116880cbdc619d8fb53caa595e1013617dea75))
* **deps-dev:** bump @faker-js/faker from 6.3.1 to 7.1.0 ([#852](https://github.com/mnfClass/ydh-myydh-crud-api/issues/852)) ([07006df](https://github.com/mnfClass/ydh-myydh-crud-api/commit/07006df373b39c73a9cfea6f6edb796090a3e726))
* **deps-dev:** bump @faker-js/faker from 7.1.0 to 7.2.0 ([#880](https://github.com/mnfClass/ydh-myydh-crud-api/issues/880)) ([91bf14b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/91bf14b26e9af01568fdaa4ebee2aa7d0fdd9e9c))
* **deps-dev:** bump @faker-js/faker from 7.2.0 to 7.3.0 ([#892](https://github.com/mnfClass/ydh-myydh-crud-api/issues/892)) ([d507ef5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d507ef571b8c78a7f25ddb55af8b42b4aa2a6fb5))
* **deps-dev:** bump @faker-js/faker from 7.3.0 to 7.4.0 ([#936](https://github.com/mnfClass/ydh-myydh-crud-api/issues/936)) ([9bb85f5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9bb85f5d168c2bd5bbdf8ea963b780893558b3bb))
* **deps-dev:** bump @faker-js/faker from 7.4.0 to 7.5.0 ([#983](https://github.com/mnfClass/ydh-myydh-crud-api/issues/983)) ([c17aea6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c17aea67dbe4b52fb93a366c03cfa75e304a6dbc))
* **deps-dev:** bump autocannon from 7.7.0 to 7.8.0 ([3a02930](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3a02930d32a9a520c384583ca8fe57f826a71535))
* **deps-dev:** bump autocannon from 7.8.0 to 7.8.1 ([27a011b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/27a011ba499562b4022922b3a005649172ddefb2))
* **deps-dev:** bump autocannon from 7.8.1 to 7.9.0 ([#819](https://github.com/mnfClass/ydh-myydh-crud-api/issues/819)) ([c2d1af8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c2d1af8598d51335edf129d0df1c8dcfa3971b5d))
* **deps-dev:** bump eslint from 8.10.0 to 8.11.0 ([49dab66](https://github.com/mnfClass/ydh-myydh-crud-api/commit/49dab66e55a067a309ffc006a5edbe31711bbdaf))
* **deps-dev:** bump eslint from 8.11.0 to 8.12.0 ([a35fc90](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a35fc90f5fcb36963b488c192d280171f5ab7ac6))
* **deps-dev:** bump eslint from 8.12.0 to 8.13.0 ([#776](https://github.com/mnfClass/ydh-myydh-crud-api/issues/776)) ([f40fe20](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f40fe201fa30fc59a9dcd3aad9e2b6f1f6056fe4))
* **deps-dev:** bump eslint from 8.13.0 to 8.14.0 ([#796](https://github.com/mnfClass/ydh-myydh-crud-api/issues/796)) ([2cf8fc7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2cf8fc738895e58723b4e92a8fab7e2a19a5b9df))
* **deps-dev:** bump eslint from 8.14.0 to 8.15.0 ([#818](https://github.com/mnfClass/ydh-myydh-crud-api/issues/818)) ([0b998a2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0b998a2dbeb70441c864a95d5d8fa625eb597bc0))
* **deps-dev:** bump eslint from 8.15.0 to 8.16.0 ([#855](https://github.com/mnfClass/ydh-myydh-crud-api/issues/855)) ([5b93b82](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5b93b828e503809586e5f3072c6a9907e6530359))
* **deps-dev:** bump eslint from 8.16.0 to 8.17.0 ([#871](https://github.com/mnfClass/ydh-myydh-crud-api/issues/871)) ([fb09c54](https://github.com/mnfClass/ydh-myydh-crud-api/commit/fb09c549fcac7919dd431da027741cdbc959912e))
* **deps-dev:** bump eslint from 8.17.0 to 8.18.0 ([#889](https://github.com/mnfClass/ydh-myydh-crud-api/issues/889)) ([cf65857](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cf65857f49687d8bc0d78fd4360580b17aa924f5))
* **deps-dev:** bump eslint from 8.18.0 to 8.19.0 ([#899](https://github.com/mnfClass/ydh-myydh-crud-api/issues/899)) ([868ca4d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/868ca4d67f93a70f0e905d9dbee6da50ecfa80dc))
* **deps-dev:** bump eslint from 8.20.0 to 8.21.0 ([#927](https://github.com/mnfClass/ydh-myydh-crud-api/issues/927)) ([aa470a3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/aa470a3d68f6626ec925f3a4fc264446787dad64))
* **deps-dev:** bump eslint from 8.21.0 to 8.22.0 ([#958](https://github.com/mnfClass/ydh-myydh-crud-api/issues/958)) ([e116177](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e116177e0fdeaf7e5fa92bd701f60dcf7c601a93))
* **deps-dev:** bump eslint from 8.22.0 to 8.23.0 ([#981](https://github.com/mnfClass/ydh-myydh-crud-api/issues/981)) ([cef8f42](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cef8f42009e7266b7090dc44d89f958dba71bfb5))
* **deps-dev:** bump eslint from 8.9.0 to 8.10.0 ([3f08f10](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3f08f10e3eee4cbfeb85d2722f70488d837e30bb))
* **deps-dev:** bump eslint-config-prettier from 8.4.0 to 8.5.0 ([7db0c86](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7db0c86876ce8a34ee1f4054ec68b316e27cf0fb))
* **deps-dev:** bump eslint-plugin-import from 2.25.4 to 2.26.0 ([#778](https://github.com/mnfClass/ydh-myydh-crud-api/issues/778)) ([8928ed9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8928ed95194d5803e4f39c31838dc6f3c65d8fdf))
* **deps-dev:** bump eslint-plugin-jest from 26.1.1 to 26.1.3 ([5169f60](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5169f60c6f3b026b52d53968c12e11a9f1aabfa4))
* **deps-dev:** bump eslint-plugin-jest from 26.1.3 to 26.1.4 ([#779](https://github.com/mnfClass/ydh-myydh-crud-api/issues/779)) ([0069c6d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0069c6d6942d2f516e2781579111b08c46a3b6ee))
* **deps-dev:** bump eslint-plugin-jest from 26.1.4 to 26.1.5 ([#798](https://github.com/mnfClass/ydh-myydh-crud-api/issues/798)) ([ce1974e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ce1974e9af92e7f3152861de7708238d4a8035a4))
* **deps-dev:** bump eslint-plugin-jest from 26.1.5 to 26.2.2 ([#825](https://github.com/mnfClass/ydh-myydh-crud-api/issues/825)) ([44cebd2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/44cebd22141c68bc51bacf181ed3b522348f64d6))
* **deps-dev:** bump eslint-plugin-jest from 26.2.2 to 26.4.6 ([#843](https://github.com/mnfClass/ydh-myydh-crud-api/issues/843)) ([5dd3f22](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5dd3f2244b7fc43edf66e0947beb1d99802b521e))
* **deps-dev:** bump eslint-plugin-jest from 26.4.6 to 26.5.3 ([#874](https://github.com/mnfClass/ydh-myydh-crud-api/issues/874)) ([e3de5a9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e3de5a93e490e1fc3f0e54ccde1ed781f2ff83a9))
* **deps-dev:** bump eslint-plugin-jest from 26.6.0 to 26.7.0 ([#922](https://github.com/mnfClass/ydh-myydh-crud-api/issues/922)) ([2750cd1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2750cd1aeb2c7adb86bc3a0fd23849d3c1c91f44))
* **deps-dev:** bump eslint-plugin-jest from 26.7.0 to 26.8.2 ([#943](https://github.com/mnfClass/ydh-myydh-crud-api/issues/943)) ([b22fb7c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b22fb7c945c7755b5ce959cb197529daddd0654d))
* **deps-dev:** bump eslint-plugin-jest from 26.8.2 to 26.8.3 ([#954](https://github.com/mnfClass/ydh-myydh-crud-api/issues/954)) ([f5eacc4](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f5eacc4d009558cd3eb04b74c2468cdcf1ed8e4a))
* **deps-dev:** bump eslint-plugin-jest from 26.8.3 to 26.8.4 ([#965](https://github.com/mnfClass/ydh-myydh-crud-api/issues/965)) ([68caf91](https://github.com/mnfClass/ydh-myydh-crud-api/commit/68caf9110574b9ed5a21fe1072e572845784e837))
* **deps-dev:** bump eslint-plugin-jest from 26.8.4 to 27.0.1 ([#985](https://github.com/mnfClass/ydh-myydh-crud-api/issues/985)) ([df2ef43](https://github.com/mnfClass/ydh-myydh-crud-api/commit/df2ef4378fd5125f970dc49ee683332484e433f4))
* **deps-dev:** bump eslint-plugin-jsdoc from 37.9.4 to 37.9.5 ([27977c9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/27977c9c505523fae292353feb6c82e415116df8))
* **deps-dev:** bump eslint-plugin-jsdoc from 37.9.5 to 37.9.7 ([f99dad1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f99dad17b997e10f895772df7850bbebd2c0b1c7))
* **deps-dev:** bump eslint-plugin-jsdoc from 37.9.7 to 38.0.6 ([87cf527](https://github.com/mnfClass/ydh-myydh-crud-api/commit/87cf527994cc944766fe31bdccfef512a103d296))
* **deps-dev:** bump eslint-plugin-jsdoc from 38.0.6 to 38.1.4 ([469e30c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/469e30ca6e16f1bf2fc8ae9eebe05f7e1e9f0f15))
* **deps-dev:** bump eslint-plugin-jsdoc from 38.1.4 to 38.1.6 ([#761](https://github.com/mnfClass/ydh-myydh-crud-api/issues/761)) ([7f608d7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7f608d78261e53adc1526fd892d6d0b233c54776))
* **deps-dev:** bump eslint-plugin-jsdoc from 38.1.6 to 39.1.1 ([#780](https://github.com/mnfClass/ydh-myydh-crud-api/issues/780)) ([f55f5c5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f55f5c5d27ba7b063c6a08f7cddc4a6ce6c20284))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.1.1 to 39.2.9 ([#790](https://github.com/mnfClass/ydh-myydh-crud-api/issues/790)) ([11f0e69](https://github.com/mnfClass/ydh-myydh-crud-api/commit/11f0e695513aa2893e5b5cfdb397f315a9d21e63))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.2.9 to 39.3.2 ([#847](https://github.com/mnfClass/ydh-myydh-crud-api/issues/847)) ([67c7138](https://github.com/mnfClass/ydh-myydh-crud-api/commit/67c7138b405deca85f6839efed4cc0a170c4ec49))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.3.2 to 39.3.3 ([#888](https://github.com/mnfClass/ydh-myydh-crud-api/issues/888)) ([5f40050](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5f4005062e256a81da22e6b7e296eaf0d7d4bb7c))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.3.3 to 39.3.4 ([#924](https://github.com/mnfClass/ydh-myydh-crud-api/issues/924)) ([54bf4ef](https://github.com/mnfClass/ydh-myydh-crud-api/commit/54bf4ef51d93cd2ddeb4cf4e40c8e3ca0c1c6f00))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.3.4 to 39.3.6 ([#941](https://github.com/mnfClass/ydh-myydh-crud-api/issues/941)) ([152406b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/152406b765046ab45906155efa10958676e872a0))
* **deps-dev:** bump eslint-plugin-promise from 6.0.0 to 6.0.1 ([#976](https://github.com/mnfClass/ydh-myydh-crud-api/issues/976)) ([0e78056](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0e7805660cbdd94b63adf5d6c9093b37a2e01f64))
* **deps-dev:** bump eslint-plugin-security from 1.4.0 to 1.5.0 ([#800](https://github.com/mnfClass/ydh-myydh-crud-api/issues/800)) ([83827d9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/83827d9a4d03245feca6d7392dcb096f1c25888a))
* **deps-dev:** bump glob from 7.2.0 to 8.0.1 ([#772](https://github.com/mnfClass/ydh-myydh-crud-api/issues/772)) ([934638c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/934638cfd316d6ed434aca2ee0fd7035d35119ab))
* **deps-dev:** bump glob from 8.0.1 to 8.0.3 ([#832](https://github.com/mnfClass/ydh-myydh-crud-api/issues/832)) ([cf09671](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cf09671bed5cab7e1c6b5832b9d919d9b52d5730))
* **deps-dev:** bump husky from 7.0.4 to 8.0.1 ([#833](https://github.com/mnfClass/ydh-myydh-crud-api/issues/833)) ([46e0dbe](https://github.com/mnfClass/ydh-myydh-crud-api/commit/46e0dbeb452fbe5f8e3dd866a631756b348e399b))
* **deps-dev:** bump jest from 27.4.7 to 27.5.1 ([40d14e1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/40d14e1fb2b8fa302a0b047034a4444d997c135f))
* **deps-dev:** bump jest from 27.5.1 to 28.0.3 ([#794](https://github.com/mnfClass/ydh-myydh-crud-api/issues/794)) ([d586ab7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d586ab78d0764f094807bbfeba9afa26ccaea87e))
* **deps-dev:** bump jest from 28.0.3 to 28.1.0 ([#824](https://github.com/mnfClass/ydh-myydh-crud-api/issues/824)) ([710749f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/710749f912cb55bd5f6a2da393e8c409d693688d))
* **deps-dev:** bump jest from 28.1.0 to 28.1.1 ([#870](https://github.com/mnfClass/ydh-myydh-crud-api/issues/870)) ([b779f5e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b779f5eb3e05741dab7c5121a86c13c5adc66fb9))
* **deps-dev:** bump jest from 28.1.1 to 28.1.2 ([#894](https://github.com/mnfClass/ydh-myydh-crud-api/issues/894)) ([d0e643b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d0e643be539ec46f9b373c58224393b61a2b874b))
* **deps-dev:** bump jest from 28.1.2 to 28.1.3 ([#912](https://github.com/mnfClass/ydh-myydh-crud-api/issues/912)) ([4619804](https://github.com/mnfClass/ydh-myydh-crud-api/commit/46198042219dbf5d8e40c9d0a10e0f7de7c3f9ac))
* **deps-dev:** bump jest from 28.1.3 to 29.0.1 ([#984](https://github.com/mnfClass/ydh-myydh-crud-api/issues/984)) ([28e2a23](https://github.com/mnfClass/ydh-myydh-crud-api/commit/28e2a23919420a22f8fee9e2594ef4c8de32bd39))
* **deps-dev:** bump jest from 29.0.1 to 29.0.2 ([#992](https://github.com/mnfClass/ydh-myydh-crud-api/issues/992)) ([62370c5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/62370c50c59bdc54fc71b287d0aa220f906a9a5c))
* **deps-dev:** bump nodemon from 2.0.15 to 2.0.16 ([#803](https://github.com/mnfClass/ydh-myydh-crud-api/issues/803)) ([b300561](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b3005614c285d21cb9a7aaaa9552e6b0a7d69836))
* **deps-dev:** bump nodemon from 2.0.16 to 2.0.19 ([#896](https://github.com/mnfClass/ydh-myydh-crud-api/issues/896)) ([55dd849](https://github.com/mnfClass/ydh-myydh-crud-api/commit/55dd84992046dc50a36bcf062c2277a4048afdfb))
* **deps-dev:** bump pino-pretty from 8.0.0 to 8.1.0 ([#893](https://github.com/mnfClass/ydh-myydh-crud-api/issues/893)) ([53e5750](https://github.com/mnfClass/ydh-myydh-crud-api/commit/53e5750b14bad4f6ce604cf09dbe606ad99c4549))
* **deps-dev:** bump pino-pretty from 8.1.0 to 9.0.1 ([#953](https://github.com/mnfClass/ydh-myydh-crud-api/issues/953)) ([20920b9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/20920b9c282f4ef796a28db4e23c9525175e8ee6))
* **deps-dev:** bump pino-pretty from 9.0.1 to 9.1.0 ([#970](https://github.com/mnfClass/ydh-myydh-crud-api/issues/970)) ([cf8cf03](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cf8cf0330b32ed41aabd531746599146e781810e))
* **deps-dev:** bump playwright from 1.18.1 to 1.19.1 ([ca80625](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ca80625672dfe959c3a273673a71b20e08f8d156))
* **deps-dev:** bump playwright from 1.19.1 to 1.19.2 ([3fa50e5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3fa50e5fa6902060e3f90e1e2e682e9c8d646d9d))
* **deps-dev:** bump playwright from 1.19.2 to 1.20.1 ([0966f34](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0966f34d15a00f5005a90c0e769b069e492a17f8))
* **deps-dev:** bump playwright from 1.20.1 to 1.20.2 ([#773](https://github.com/mnfClass/ydh-myydh-crud-api/issues/773)) ([b3b88bd](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b3b88bdc2aa84870a0e5174b17d2d98848225cbf))
* **deps-dev:** bump playwright from 1.20.2 to 1.21.1 ([#799](https://github.com/mnfClass/ydh-myydh-crud-api/issues/799)) ([d36fb31](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d36fb31a08ce2dc08d0084af33f6ca9d064f1354))
* **deps-dev:** bump playwright from 1.21.1 to 1.22.1 ([#829](https://github.com/mnfClass/ydh-myydh-crud-api/issues/829)) ([1767427](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1767427def5de20abed0db64d7d8884cb4a9f0fe))
* **deps-dev:** bump playwright from 1.22.1 to 1.22.2 ([#845](https://github.com/mnfClass/ydh-myydh-crud-api/issues/845)) ([da88bac](https://github.com/mnfClass/ydh-myydh-crud-api/commit/da88bacc401dac40b0a14a278cce5e9d587d4556))
* **deps-dev:** bump playwright from 1.22.2 to 1.23.2 ([#898](https://github.com/mnfClass/ydh-myydh-crud-api/issues/898)) ([5cadef8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5cadef86fa31991ca9ce56d37a343e4815e251cb))
* **deps-dev:** bump playwright from 1.23.2 to 1.23.3 ([#911](https://github.com/mnfClass/ydh-myydh-crud-api/issues/911)) ([5169629](https://github.com/mnfClass/ydh-myydh-crud-api/commit/51696298d254e89d58720810e08b7fbacf2a4db3))
* **deps-dev:** bump playwright from 1.24.1 to 1.24.2 ([#923](https://github.com/mnfClass/ydh-myydh-crud-api/issues/923)) ([32009bf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/32009bf89952183cb9bba8a1cc65bb1b498a33c2))
* **deps-dev:** bump playwright from 1.24.2 to 1.25.0 ([#952](https://github.com/mnfClass/ydh-myydh-crud-api/issues/952)) ([87baeaf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/87baeaff549649fb83b97473b3af39f31427a804))
* **deps-dev:** bump playwright from 1.25.0 to 1.25.1 ([#988](https://github.com/mnfClass/ydh-myydh-crud-api/issues/988)) ([cf2b17f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cf2b17f10c47d7dd33682219ed14118f24563916))
* **deps-dev:** bump prettier from 2.5.1 to 2.6.0 ([812a91b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/812a91bf71bc7450443daf0e7897ec60cc93e014))
* **deps-dev:** bump prettier from 2.6.0 to 2.6.1 ([9130c98](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9130c98e11a1baf9b06303ac67d7fc4aef7dd3f9))
* **deps-dev:** bump prettier from 2.6.1 to 2.6.2 ([#762](https://github.com/mnfClass/ydh-myydh-crud-api/issues/762)) ([bde1552](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bde1552ad825c1e9a82b9f55b13e79e2abb4d451))
* **deps-dev:** bump prettier from 2.6.2 to 2.7.1 ([#876](https://github.com/mnfClass/ydh-myydh-crud-api/issues/876)) ([e382617](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e382617ddea869f484c4430adc16cb0c42c3c191))
* **deps-dev:** replace `faker` with `@faker-js/faker` ([#732](https://github.com/mnfClass/ydh-myydh-crud-api/issues/732)) ([f0e778f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f0e778f73ca2174bec876ed1858218a2093a8068))
* **deps:** bump @fastify/accepts from 4.0.0 to 4.0.1 ([#971](https://github.com/mnfClass/ydh-myydh-crud-api/issues/971)) ([26ba135](https://github.com/mnfClass/ydh-myydh-crud-api/commit/26ba13574d989f8b363667cd211f1bde55992504))
* **deps:** bump @fastify/autoload from 4.0.0 to 4.0.1 ([#808](https://github.com/mnfClass/ydh-myydh-crud-api/issues/808)) ([164d486](https://github.com/mnfClass/ydh-myydh-crud-api/commit/164d4860b888360d9ab091b9be50317941d3ec9b))
* **deps:** bump @fastify/autoload from 4.0.1 to 5.1.0 ([#904](https://github.com/mnfClass/ydh-myydh-crud-api/issues/904)) ([8e08931](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8e089314a22f7d8671c08de3d9957ca93778eb38))
* **deps:** bump @fastify/autoload from 5.1.0 to 5.2.0 ([#938](https://github.com/mnfClass/ydh-myydh-crud-api/issues/938)) ([abac682](https://github.com/mnfClass/ydh-myydh-crud-api/commit/abac68200ed64600102f736208ea6c016b77049a))
* **deps:** bump @fastify/autoload from 5.2.0 to 5.3.0 ([#982](https://github.com/mnfClass/ydh-myydh-crud-api/issues/982)) ([857fccf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/857fccf0686ac9e0bbf83b3ad12071caf13b3930))
* **deps:** bump @fastify/autoload from 5.3.0 to 5.3.1 ([#990](https://github.com/mnfClass/ydh-myydh-crud-api/issues/990)) ([137463f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/137463f8a8c1b2e15aa7021285d96f238aab5bf3))
* **deps:** bump @fastify/basic-auth from 3.0.0 to 3.0.1 ([#805](https://github.com/mnfClass/ydh-myydh-crud-api/issues/805)) ([59ba9d2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/59ba9d26a9c3b12d73688a12b8fc669e50c30fab))
* **deps:** bump @fastify/basic-auth from 3.0.1 to 3.0.2 ([#820](https://github.com/mnfClass/ydh-myydh-crud-api/issues/820)) ([64e4e4a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/64e4e4a116dfc67ddb8fa0cb3f4a5724fdd54307))
* **deps:** bump @fastify/bearer-auth from 7.0.0 to 7.0.1 ([#809](https://github.com/mnfClass/ydh-myydh-crud-api/issues/809)) ([b2c7a99](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b2c7a99a2e462e5384006d4ee92e4cb750b95f3f))
* **deps:** bump @fastify/compress from 6.1.0 to 6.1.1 ([#986](https://github.com/mnfClass/ydh-myydh-crud-api/issues/986)) ([7d1ae20](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7d1ae20494bd00a1f60943b9dfff36691065b05a))
* **deps:** bump @fastify/cors from 8.0.0 to 8.1.0 ([#932](https://github.com/mnfClass/ydh-myydh-crud-api/issues/932)) ([193d2f1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/193d2f1a7d34e318a78f44616ff050efbda1efd0))
* **deps:** bump @fastify/helmet from 8.0.0 to 8.0.1 ([#821](https://github.com/mnfClass/ydh-myydh-crud-api/issues/821)) ([61f5afb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/61f5afb3fd26cec25014c369572fd21ef70ed64b))
* **deps:** bump @fastify/helmet from 8.0.1 to 8.1.0 ([#848](https://github.com/mnfClass/ydh-myydh-crud-api/issues/848)) ([9c7656e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9c7656e08ccc17d61cd3c198492f57b97f021c36))
* **deps:** bump @fastify/helmet from 9.1.0 to 10.0.0 ([#991](https://github.com/mnfClass/ydh-myydh-crud-api/issues/991)) ([fdab9b9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/fdab9b9a5982d0dda5bec71eced41f5f3754c2e3))
* **deps:** bump @fastify/rate-limit from 6.0.0 to 6.0.1 ([#849](https://github.com/mnfClass/ydh-myydh-crud-api/issues/849)) ([d8e2b7f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d8e2b7f30fb224e11185a6cd582d262731078127))
* **deps:** bump @fastify/rate-limit from 7.3.0 to 7.4.0 ([#975](https://github.com/mnfClass/ydh-myydh-crud-api/issues/975)) ([856b599](https://github.com/mnfClass/ydh-myydh-crud-api/commit/856b59912c7abd3ef4369d266674b632934bcf59))
* **deps:** bump @fastify/sensible from 4.0.0 to 4.1.0 ([#826](https://github.com/mnfClass/ydh-myydh-crud-api/issues/826)) ([2321c5e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2321c5ea76b002db2e2a4f26f51737cea8a6a1ca))
* **deps:** bump @fastify/sensible from 5.1.0 to 5.1.1 ([#980](https://github.com/mnfClass/ydh-myydh-crud-api/issues/980)) ([0963232](https://github.com/mnfClass/ydh-myydh-crud-api/commit/09632326bb5c88e5ca61ae6efae4cc1b884609cb))
* **deps:** bump @fastify/static from 5.0.0 to 5.0.1 ([#806](https://github.com/mnfClass/ydh-myydh-crud-api/issues/806)) ([0374f2d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0374f2d8c1520c83b9cd3bc07654a20001e348f8))
* **deps:** bump @fastify/static from 5.0.1 to 5.0.2 ([#828](https://github.com/mnfClass/ydh-myydh-crud-api/issues/828)) ([2f15ccd](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2f15ccdce1de5700f40309c21e0e7c3cf6ce11db))
* **deps:** bump @fastify/static from 6.4.1 to 6.5.0 ([#926](https://github.com/mnfClass/ydh-myydh-crud-api/issues/926)) ([46698b7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/46698b741d2326a4819a4e1cfdf5165713825149))
* **deps:** bump @fastify/swagger from 7.4.1 to 7.5.0 ([#979](https://github.com/mnfClass/ydh-myydh-crud-api/issues/979)) ([9e5c9e6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9e5c9e6a61b5e957ebb9c30ea217977781b87196))
* **deps:** bump @fastify/under-pressure from 7.0.0 to 8.0.0 ([#957](https://github.com/mnfClass/ydh-myydh-crud-api/issues/957)) ([6633d5d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6633d5d3fb3f3e410283e17d0d4e2391d2dca56b))
* **deps:** bump @fastify/under-pressure from 8.0.0 to 8.1.0 ([#972](https://github.com/mnfClass/ydh-myydh-crud-api/issues/972)) ([55ca85b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/55ca85bd822290e429803db4db0a00e67cc29ce3))
* **deps:** bump actions/checkout from 2 to 3 ([0092287](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0092287c0b3f926b84479a67cf3440f303363f77))
* **deps:** bump actions/dependency-review-action from 1 to 2 ([#867](https://github.com/mnfClass/ydh-myydh-crud-api/issues/867)) ([bf19626](https://github.com/mnfClass/ydh-myydh-crud-api/commit/bf19626b045380863edb60fafa7e7078e2338c13))
* **deps:** bump actions/setup-node from 2 to 3 ([4dade2e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/4dade2e8126154f12ccf9ee491ea97a6e2027d18))
* **deps:** bump actions/upload-artifact from 2 to 3 ([#771](https://github.com/mnfClass/ydh-myydh-crud-api/issues/771)) ([793d028](https://github.com/mnfClass/ydh-myydh-crud-api/commit/793d028ce8fb5a1d87d9f15a03b5dceb255e600b))
* **deps:** bump dotenv from 16.0.0 to 16.0.1 ([#823](https://github.com/mnfClass/ydh-myydh-crud-api/issues/823)) ([1244eee](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1244eee3d32aeabf9505bdc37429b5c93facf548))
* **deps:** bump dotenv from 16.0.1 to 16.0.2 ([#987](https://github.com/mnfClass/ydh-myydh-crud-api/issues/987)) ([6cdb73b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6cdb73b844d0e2c569212015126232f22ce4658e))
* **deps:** bump env-schema from 3.5.2 to 4.0.0 ([6c36a7d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6c36a7d48dae8386c4d2080dbbeb7afd7a22324a))
* **deps:** bump env-schema from 4.0.0 to 5.0.0 ([#854](https://github.com/mnfClass/ydh-myydh-crud-api/issues/854)) ([a4a82e8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a4a82e81f9b7ea490bdd394d8710d0afecebe5a3))
* **deps:** bump fastify from 3.27.2 to 3.27.3 ([89a31ec](https://github.com/mnfClass/ydh-myydh-crud-api/commit/89a31ece879f37cca9c4339e2e695290dcad60cc))
* **deps:** bump fastify from 3.27.3 to 3.27.4 ([9a14063](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9a1406316214e91ac4e267b1a549159619f7b42f))
* **deps:** bump fastify from 3.27.4 to 3.28.0 ([#763](https://github.com/mnfClass/ydh-myydh-crud-api/issues/763)) ([1c3c667](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1c3c6675fb47c90d516f6683cf2ce58f071a8e1a))
* **deps:** bump fastify from 3.28.0 to 3.29.0 ([#802](https://github.com/mnfClass/ydh-myydh-crud-api/issues/802)) ([ea40746](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ea4074642d8f0d43f4d4c5068e9d4448e0a701f4))
* **deps:** bump fastify from 4.3.0 to 4.4.0 ([#939](https://github.com/mnfClass/ydh-myydh-crud-api/issues/939)) ([df91e44](https://github.com/mnfClass/ydh-myydh-crud-api/commit/df91e4494825a278ff805ecc3a9fa172370b5f90))
* **deps:** bump fastify from 4.4.0 to 4.5.0 ([#955](https://github.com/mnfClass/ydh-myydh-crud-api/issues/955)) ([f9c4c6f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f9c4c6fa334d0f7a9d56f7dcc361a38a1669f87a))
* **deps:** bump fastify from 4.5.0 to 4.5.2 ([#964](https://github.com/mnfClass/ydh-myydh-crud-api/issues/964)) ([8af1527](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8af15272120df67e1301b1a52cbd1ee1b2f3acdb))
* **deps:** bump fastify from 4.5.2 to 4.5.3 ([#977](https://github.com/mnfClass/ydh-myydh-crud-api/issues/977)) ([8284f5b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8284f5b1450aff18a2a5e412bd7c667eb23f510e))
* **deps:** bump fastify-accepts from 2.1.0 to 2.2.0 ([485bdd5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/485bdd5807181cfe731dbb13c2bf13b2106321a0))
* **deps:** bump fastify-disablecache from 2.0.5 to 2.0.6 ([6885228](https://github.com/mnfClass/ydh-myydh-crud-api/commit/68852286c4c2092accba728fcee852f653f3815f))
* **deps:** bump fastify-disablecache from 2.0.6 to 2.0.7 ([0e1f975](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0e1f97549ee84fa2b33730d17aed4bb322f2280b))
* **deps:** bump fastify-disablecache from 3.0.0 to 3.0.1 ([#919](https://github.com/mnfClass/ydh-myydh-crud-api/issues/919)) ([95d02f8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/95d02f84c744e3769668d36de7de72c29530acc4))
* **deps:** bump fastify-disablecache from 3.0.1 to 3.0.2 ([#935](https://github.com/mnfClass/ydh-myydh-crud-api/issues/935)) ([46e74cf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/46e74cfbe8855131a1215aac17083fffa48494d2))
* **deps:** bump fastify-floc-off from 1.0.4 to 1.0.5 ([87c3c93](https://github.com/mnfClass/ydh-myydh-crud-api/commit/87c3c9343f0821352955ad30140029895c220cad))
* **deps:** bump fastify-floc-off from 1.0.5 to 1.0.6 ([811410c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/811410c3445cd0a44ea4a0104dcc256f6bb2b4e4))
* **deps:** bump fastify-floc-off from 2.0.0 to 2.0.1 ([#917](https://github.com/mnfClass/ydh-myydh-crud-api/issues/917)) ([1b7be43](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1b7be437cd75439094b18875cecbeff28b43bfcf))
* **deps:** bump fastify-floc-off from 2.0.1 to 2.0.2 ([#944](https://github.com/mnfClass/ydh-myydh-crud-api/issues/944)) ([576b1d3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/576b1d3322ea365798c4e49dc6c39d332d3c36bf))
* **deps:** bump fastify-plugin from 3.0.1 to 4.0.0 ([#907](https://github.com/mnfClass/ydh-myydh-crud-api/issues/907)) ([3d38d67](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3d38d67e38e5ee09844811483fef8e133882e585))
* **deps:** bump fastify-plugin from 4.1.0 to 4.2.0 ([#950](https://github.com/mnfClass/ydh-myydh-crud-api/issues/950)) ([33c7678](https://github.com/mnfClass/ydh-myydh-crud-api/commit/33c76785036e487451b5af526acc560cb016d430))
* **deps:** bump fastify-plugin from 4.2.0 to 4.2.1 ([#989](https://github.com/mnfClass/ydh-myydh-crud-api/issues/989)) ([4d22ddf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/4d22ddf020d6f02d5f6899003013777d2ae0841f))
* **deps:** bump fastify-static from 4.5.0 to 4.6.1 ([0d37fee](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0d37fee761c2158c9ebeee381063a6fd2c145602))
* **deps:** bump fluent-json-schema from 3.0.1 to 3.1.0 ([b4d6469](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b4d64692439e4fadd90f34300951291b47f11411))
* **deps:** bump github/codeql-action from 1 to 2 ([#789](https://github.com/mnfClass/ydh-myydh-crud-api/issues/789)) ([b2717f8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b2717f844195247339cf64f4bd86d376fcecf5d2))
* **deps:** bump hadolint/hadolint-action from 1.6.0 to 1.7.0 ([3065cec](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3065cec4741e6e14dd59b2976727a1c3329e9d90))
* **deps:** bump hadolint/hadolint-action from 1.7.0 to 2.0.0 ([655ffe7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/655ffe72255db32908ce16a9334d471b57e53088))
* **deps:** bump hadolint/hadolint-action from 2.0.0 to 2.1.0 ([#755](https://github.com/mnfClass/ydh-myydh-crud-api/issues/755)) ([e067f80](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e067f8031f3fb00860565dfbd4e506f99764db6b))
* **deps:** bump jstoxml from 2.2.9 to 3.1.0 ([7d8faa2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7d8faa2ac54551d6f68e1441efc9ae684e67bb17))
* **deps:** bump jstoxml from 3.1.0 to 3.2.0 ([69bd77d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/69bd77d60bdab9c008866c463f46b2699cca4476))
* **deps:** bump jstoxml from 3.2.0 to 3.2.2 ([f717f93](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f717f93afce6e97146ddd3a20f5094ed573d3568))
* **deps:** bump minimist from 1.2.5 to 1.2.6 ([5940bd8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5940bd85cbd45ae9484d168a2d93a530d28bcbb8))
* **deps:** bump moment from 2.29.1 to 2.29.2 ([#768](https://github.com/mnfClass/ydh-myydh-crud-api/issues/768)) ([ae97d2e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ae97d2eda6b8bc0ea250762b3d33f34547f8e600))
* **deps:** bump moment from 2.29.3 to 2.29.4 ([#901](https://github.com/mnfClass/ydh-myydh-crud-api/issues/901)) ([8ee8d8b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8ee8d8ba3fbb6a64c7a1ff1f1d3e01932854839c))
* **deps:** bump mssql from 8.0.1 to 8.0.2 ([385310c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/385310c3150fe3a73ab0369569604f7ce4ec2c9c))
* **deps:** bump mssql from 8.0.2 to 8.1.0 ([#774](https://github.com/mnfClass/ydh-myydh-crud-api/issues/774)) ([1ba46cd](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1ba46cd9c0f57c744711a1a77211cbf1724f21e6))
* **deps:** bump mssql from 8.1.0 to 8.1.1 ([#834](https://github.com/mnfClass/ydh-myydh-crud-api/issues/834)) ([f5ce96c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f5ce96cc1a8bfddcbf1e47b942b10e1e545477ad))
* **deps:** bump mssql from 8.1.1 to 8.1.2 ([#850](https://github.com/mnfClass/ydh-myydh-crud-api/issues/850)) ([2b8173c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2b8173c480aad8babb7c04680142890e3eccb0e0))
* **deps:** bump mssql from 8.1.2 to 8.1.3 ([#937](https://github.com/mnfClass/ydh-myydh-crud-api/issues/937)) ([02eadef](https://github.com/mnfClass/ydh-myydh-crud-api/commit/02eadefb1c3f6407dc2df6e3aaed3c1b71f2ed6f))
* **deps:** bump mssql from 8.1.3 to 9.0.0 ([#949](https://github.com/mnfClass/ydh-myydh-crud-api/issues/949)) ([b18a65d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b18a65d1a54c9450dbf3527e497e6f7c63e1d3d6))
* **deps:** bump mssql from 9.0.0 to 9.0.1 ([#962](https://github.com/mnfClass/ydh-myydh-crud-api/issues/962)) ([8e7097d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8e7097df2afd505a067d4a01a05096d774b9106a))
* **deps:** bump peter-evans/create-pull-request from 3 to 4 ([1a3bc0f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1a3bc0f9660873834bec386f1471d75c895a8bd1))
* **deps:** bump pg from 8.7.3 to 8.8.0 ([#974](https://github.com/mnfClass/ydh-myydh-crud-api/issues/974)) ([a148e62](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a148e62b388b0b2168d778a4bc2e9eba019062aa))
* **deps:** bump pino from 7.10.0 to 7.11.0 ([#791](https://github.com/mnfClass/ydh-myydh-crud-api/issues/791)) ([119ba82](https://github.com/mnfClass/ydh-myydh-crud-api/commit/119ba82f726fc5f2dce4ff1f91376e1e8326db10))
* **deps:** bump pino from 7.11.0 to 8.0.0 ([#859](https://github.com/mnfClass/ydh-myydh-crud-api/issues/859)) ([b84d800](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b84d800ae4d83c828f8d16367ddab229aa20a91b))
* **deps:** bump pino from 7.8.0 to 7.8.1 ([ab24c5f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ab24c5f6e8669c53ab2f2e5a4e5afaf82fa5481d))
* **deps:** bump pino from 7.8.1 to 7.9.2 ([53eefaf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/53eefafea1f78fa1ff3e551d5cee142facba8049))
* **deps:** bump pino from 7.9.2 to 7.10.0 ([#777](https://github.com/mnfClass/ydh-myydh-crud-api/issues/777)) ([2183c2e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2183c2e4d726f0b97acaa10186b06b870ca03f71))
* **deps:** bump pino from 8.0.0 to 8.1.0 ([#903](https://github.com/mnfClass/ydh-myydh-crud-api/issues/903)) ([6332c9b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6332c9bb6944c606c76eb144eef1bf35257e27ef))
* **deps:** bump pino from 8.3.0 to 8.3.1 ([#918](https://github.com/mnfClass/ydh-myydh-crud-api/issues/918)) ([b71278e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b71278e774faf9e27c90092c3b5f1f555ad3615f))
* **deps:** bump pino from 8.3.1 to 8.4.0 ([#942](https://github.com/mnfClass/ydh-myydh-crud-api/issues/942)) ([e5631a8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e5631a8491a9c3ff0708ba0e35c98750816513c1))
* **deps:** bump pino from 8.4.0 to 8.4.1 ([#956](https://github.com/mnfClass/ydh-myydh-crud-api/issues/956)) ([782cebb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/782cebb4879942b5b762e3d68911c9b962fb5c26))
* **deps:** bump pino from 8.4.1 to 8.4.2 ([#966](https://github.com/mnfClass/ydh-myydh-crud-api/issues/966)) ([119ef10](https://github.com/mnfClass/ydh-myydh-crud-api/commit/119ef106213941a4848351401d1d06e6c0fec282))
* **deps:** bump pino-pretty from 7.5.1 to 7.5.3 ([b7d39a4](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b7d39a48c40c6b60f53dd7990d14cc24136109fb))
* **deps:** bump pino-pretty from 7.5.3 to 7.5.4 ([144ad21](https://github.com/mnfClass/ydh-myydh-crud-api/commit/144ad2138335ab35f7427c10bd0a8ce155ae927c))
* **deps:** bump pino-pretty from 7.5.4 to 7.6.0 ([a29b1af](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a29b1afe82ac712b73e7340d85f7cdb17dca3f0f))
* **deps:** bump pino-pretty from 7.6.0 to 7.6.1 ([#775](https://github.com/mnfClass/ydh-myydh-crud-api/issues/775)) ([7e00ceb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7e00ceb31f10f1ab85596b330f76671f45bb6e7a))
* **deps:** bump pino-pretty from 7.6.1 to 8.0.0 ([#858](https://github.com/mnfClass/ydh-myydh-crud-api/issues/858)) ([2b275b3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2b275b3ebe8c52960cf314bf0501a5c6ed75374d))
* **deps:** bump prismjs from 1.26.0 to 1.27.0 ([143ecf8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/143ecf8203c2cc9ed3762fa81f0df977aac4c32d))
* **deps:** bump redoc from 2.0.0-rc.63 to 2.0.0-rc.64 ([a9f5933](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a9f59339e8150fa89d4dc41a7e8535d17d5c7a9c))
* **deps:** bump redoc from 2.0.0-rc.64 to 2.0.0-rc.65 ([0d87c0e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0d87c0ef256653c2f0b2a379a27763499984bff7))
* **deps:** bump redoc from 2.0.0-rc.65 to 2.0.0-rc.66 ([dc406f9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/dc406f90aa0fe775de9623185052369285d15b29))
* **deps:** bump redoc from 2.0.0-rc.66 to 2.0.0-rc.67 ([#795](https://github.com/mnfClass/ydh-myydh-crud-api/issues/795)) ([760a08c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/760a08c0b691c4d5f136196c0ace6c526cb2f4ff))
* **deps:** bump redoc from 2.0.0-rc.67 to 2.0.0-rc.70 ([#822](https://github.com/mnfClass/ydh-myydh-crud-api/issues/822)) ([b7454f7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b7454f764ebea9568d69f8d72b2f2e4f62b07bf6))
* **deps:** bump redoc from 2.0.0-rc.70 to 2.0.0-rc.71 ([#853](https://github.com/mnfClass/ydh-myydh-crud-api/issues/853)) ([391d161](https://github.com/mnfClass/ydh-myydh-crud-api/commit/391d161c0c7b1e1dacf2e46792662c6082e98cf7))
* **deps:** bump redoc from 2.0.0-rc.71 to 2.0.0-rc.72 ([#879](https://github.com/mnfClass/ydh-myydh-crud-api/issues/879)) ([fdabcf1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/fdabcf17dfd37151542020f861a06213b8519d3a))
* **deps:** bump redoc from 2.0.0-rc.72 to 2.0.0-rc.74 ([#921](https://github.com/mnfClass/ydh-myydh-crud-api/issues/921)) ([9d0afe3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9d0afe3359e9325d63fd0b942ceedf52ef8a4d42))
* **deps:** bump redoc from 2.0.0-rc.74 to 2.0.0-rc.75 ([#951](https://github.com/mnfClass/ydh-myydh-crud-api/issues/951)) ([610855e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/610855e490845b18c07e70ebc5d84f1f0fcde42a))
* **deps:** bump redoc from 2.0.0-rc.75 to 2.0.0-rc.76 ([#963](https://github.com/mnfClass/ydh-myydh-crud-api/issues/963)) ([0ad4f8a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0ad4f8aa177cb1122ede4738e1f22f4371a021b7))
* **deps:** bump secure-json-parse from 2.4.0 to 2.5.0 ([#925](https://github.com/mnfClass/ydh-myydh-crud-api/issues/925)) ([8cb00ca](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8cb00caf61b9721670aeb4f89ac7ace9f8ac3e8a))
* **deps:** bump sub-dependencies ([f155618](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f1556183d02136cb4b25a77694d3effc64f1bf95))
* **deps:** bump sub-dependencies ([6384ee0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6384ee06ac7bb6908611bdb1c5cd057b99186347))
* **deps:** bump sub-dependencies ([6ec9989](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6ec9989d0a6f26c49d79d41fe7d09db796526c70))
* **deps:** bump sub-dependencies ([#681](https://github.com/mnfClass/ydh-myydh-crud-api/issues/681)) ([ea94d3d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ea94d3d67042ac84e4ea3668087c05bdd97c66a1))
* **deps:** bump sub-dependencies ([#733](https://github.com/mnfClass/ydh-myydh-crud-api/issues/733)) ([3667511](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3667511f460cc69a231e5bf1b40ba3515c27902e))
* **deps:** bump sub-dependencies ([#890](https://github.com/mnfClass/ydh-myydh-crud-api/issues/890)) ([d1bdc09](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d1bdc09275fddc78c19700d678e62d1d311aeb84))
* **deps:** bump sub-dependencies ([#913](https://github.com/mnfClass/ydh-myydh-crud-api/issues/913)) ([4761fe8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/4761fe865d20b8773a016d8caeafc704e76622f6))
* **deps:** bump sub-dependencies ([#928](https://github.com/mnfClass/ydh-myydh-crud-api/issues/928)) ([81aba30](https://github.com/mnfClass/ydh-myydh-crud-api/commit/81aba3011fe23aaad32319d33245c442c1d60794))
* **deps:** bump sub-dependencies ([#959](https://github.com/mnfClass/ydh-myydh-crud-api/issues/959)) ([7a777be](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7a777be8ab69639f8e96d9175f5e51aa58950585))
* **deps:** bump transistive dependencies ([f92c4ec](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f92c4ecb435c2321b9cbd7f7ffdda596eaa34e6c))
* **deps:** bump under-pressure from 5.8.0 to 5.8.1 ([#807](https://github.com/mnfClass/ydh-myydh-crud-api/issues/807)) ([d71a627](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d71a627cd17a73cca8cd1980f41996b0c5b25421))
* **deps:** bump wagoid/commitlint-github-action from 4 to 5 ([#866](https://github.com/mnfClass/ydh-myydh-crud-api/issues/866)) ([3cf62c0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3cf62c096db9feccebe1097fff288b15efb21f6b))
* **deps:** move pino-pretty to dev dependencies ([c058cf7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c058cf7e4be876a398856c2e02092914cbf17626))
* **deps:** replace `jstoxml` with `js2xmlparser` ([0db4d85](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0db4d8536843c6c5df35b712ef0b8d6a191d1827))
* **docker:** install production deps only ([#769](https://github.com/mnfClass/ydh-myydh-crud-api/issues/769)) ([b2d4367](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b2d43671205daa3615eea035a08170941777612c))
* use new `[@fastify](https://github.com/fastify)` org dependencies ([#787](https://github.com/mnfClass/ydh-myydh-crud-api/issues/787)) ([de8f603](https://github.com/mnfClass/ydh-myydh-crud-api/commit/de8f603896e66405090bdab0d362269ab18db4f7))


### Continuous Integration

* add dependency-review job ([1680253](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1680253fc0def0ca3ee13cb1b91a267082fadc9f))
* add image optimisation workflow ([#688](https://github.com/mnfClass/ydh-myydh-crud-api/issues/688)) ([cf99a27](https://github.com/mnfClass/ydh-myydh-crud-api/commit/cf99a27596cc6aef6a148955c21d53b74f261ac6))
* add job step names, workflow comments, and whitespace ([7148a32](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7148a326b975fd41d5743f18628b0a958020d009))
* **automerge:** fix context ([1c59f9b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1c59f9b45bfea3c09e30ba980132fea747c8b56f))
* **automerge:** squash automerge prs ([c76b8e8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c76b8e818f5664482e79710deb53b3d1fe420734))
* **cd:** update org name for release-please-action ([afc30e2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/afc30e26ee18a35929cc60669d47f6cb8b6e0e9d))
* check `user.login` is dependabot instead of `actor` ([ff8c54a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ff8c54a78a702aef31f94c05dfce2032ae9c3d76))
* **ci:** add node 18 to test matrix ([#814](https://github.com/mnfClass/ydh-myydh-crud-api/issues/814)) ([8816b94](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8816b944edabf2ff2aec413b685d7f23694aea8c))
* **ci:** audit npm package signatures ([aa6e88f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/aa6e88f855271d870e17bf6eeaf98106afd068e0))
* **ci:** require `unit-tests` job to pass for `save-pr-number` job to run ([de58477](https://github.com/mnfClass/ydh-myydh-crud-api/commit/de5847771a5964d033c3145fc6832a3850d948f0))
* **ci:** use `lts/*` for node setup in lint job ([55a22eb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/55a22eb7d265f53843922f2b0481851ea4b3cdf1))
* **ci:** use `node-version` for node matrix key ([1b1b004](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1b1b004b2027c82e3976ed659b9275a63cc3daf7))
* **codeql-analysis:** remove unused autobuild step ([ed2152a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ed2152a3469a017e830b74ab15347dcb972fca43))
* **codeql:** grant minimum permissions to run; rename file ([#714](https://github.com/mnfClass/ydh-myydh-crud-api/issues/714)) ([76682c5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/76682c5346778de47ec0ce0ffcdd99d7645e5651))
* **codeql:** only run on pr changes to `.html`, `.js`, and `.yml` files ([981e1d3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/981e1d3b3b0d07bf1c1bee08c640b91db81e8403))
* **codeql:** resolve missing analyses ([85d6eb5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/85d6eb57525bac66418e42e3113e4c0120fec2c7))
* **codeql:** specify which files to scan during analysis ([e3f2452](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e3f2452cb239f9090ab3d7b78d67ce1c249de5cb))
* **link-check:** replace `npx linkinator` call with github action ([8842588](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8842588c14057abb1acb72bd0d113797c434cb9e))
* **link-check:** skip checking ydh domain ([3bb16fb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3bb16fb328814c7488757da88ab3cc90b3fbe478))
* only install chromium and firefox with playwright ([3a9123f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3a9123f47ca93be1be256af64c0c48996a280ea7))
* only save pr number artifact for dependabot ([75431a7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/75431a72898bc865c33ce2c931d7ea062952326b))
* only trigger dependency-review on pr ([c62594c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c62594c8e8c8d8f9d9b4d74110d52ce08bbbd594))
* reduce workflow permissions to minimum ([e601476](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e601476154db5eb1ed0059479e4495c6213b7862))
* remove git credentials after checkout ([#836](https://github.com/mnfClass/ydh-myydh-crud-api/issues/836)) ([10f740b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/10f740b90058fc9be31b28230ed06bc272eb73f9))
* replace workflow-run-cleanup-action with github concurrency ([d52b642](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d52b64230de21f2eb252a27bc4a3e27b7d97ee2f))
* test migrations ([#765](https://github.com/mnfClass/ydh-myydh-crud-api/issues/765)) ([8fc3392](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8fc33925206f6d45edd130d212e8892eacbf6690))
* use docker compose v2 ([87d2e18](https://github.com/mnfClass/ydh-myydh-crud-api/commit/87d2e182f85ccaac2877e5ea55e0c3cf821b3f01))
* use shorter arg aliases for lockfile lint step ([0b2b94a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0b2b94a2291d731381c2e67e088559e2592f96c7))
* validate that resolved url matches the package name ([925f84c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/925f84c59a1ab086e46255ea8a6e478a34794650))


### Improvements

* access `fs/promises` api via newer route ([69c90c0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/69c90c02e25c0fbd216da6d434f9d82913621433))
* chain response functions ([e8b917c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e8b917cb3ec014bf87e2ab29a354b8e101719a60))
* check accept header is supported before parsing req body ([dbb7ee2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/dbb7ee2929b5c958ccb6df057f60ff86332b84c6))
* **config:** replace `forEach()` with `map()` ([#838](https://github.com/mnfClass/ydh-myydh-crud-api/issues/838)) ([17339cb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/17339cbaeace16e27428b40044552e7e8d06610e))
* convert sync async handlers to sync only ([6bdec2d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6bdec2d5c538570abda92dbe151ce480bf499555))
* migrate from fastify v3 to v4 ([#914](https://github.com/mnfClass/ydh-myydh-crud-api/issues/914)) ([696833f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/696833f17e2eb6304ced55fe1a5aadc1ccc57530))
* **migrate:** convert callback to async ([0db24e8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0db24e81eefba1192e2005a63c5f7315befcefd7))
* **migrate:** replace path with upath ([ea7cfbc](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ea7cfbc9d25c4596d0ac56a61b67f518d5c5681c))
* **migrate:** use db variable in switch statement ([6a6cd98](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6a6cd98f83657d73a0b1a8b031be1e50291d61bd))
* **migrations/mssql:** merge `create schema` queries ([e7d939d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e7d939d61904e3d86c1d74d4be4aa66a675705ee))
* **plugins/db:** remove case declaration ([d7501b2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d7501b244f968d7d5712edc6553098f105681a3c))
* **plugins/hashed-bearer-auth:** replace blocking `for()` loop ([e76b8ee](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e76b8eeace50e83c46af1a48f9130264f657a3f6))
* **plugins/serialize-json-to-xml:** consolidate if statements ([17b2d6a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/17b2d6adfd38f28dddc1f6bf640eb2be4d13a427))
* **plugins/serialize-json-to-xml:** minify xml responses ([10c453e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/10c453e567ccea2ea19403701f4cad61178bb229))
* **plugins/serialize-json-to-xml:** target application/json only ([#751](https://github.com/mnfClass/ydh-myydh-crud-api/issues/751)) ([de60eac](https://github.com/mnfClass/ydh-myydh-crud-api/commit/de60eacfc63411d8e8874e9a66b45e2c59ac8004))
* **public/image/icons:** compress mask-icon ([9f3a98b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9f3a98bf681b7faa8749523c8528176f76c84a6d))
* **public/images/icons:** compress apple-touch-icons ([#685](https://github.com/mnfClass/ydh-myydh-crud-api/issues/685)) ([980d619](https://github.com/mnfClass/ydh-myydh-crud-api/commit/980d61904d28eb34dbb460c947380bd4ceebdda0))
* **public:** remove unused web app manifest and icons ([9be9162](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9be9162ff5c85bdd6f9e80cd7ed9fed759068a89))
* remove redundant returns ([a3857e1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a3857e1cef2b596c2564e098dea2fc4fde78958e))
* replace pbkdf2 with scrypt ([f565d57](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f565d570bbc5d69ec407a671a067d888c22dbbce))
* **routes/admin/access/b-t:** remove unused param ([674b6cd](https://github.com/mnfClass/ydh-myydh-crud-api/commit/674b6cdaee70c047b9544c8f0f3f5b5835573d37))
* **routes/admin/access/bearer-token:** remove reassignment of var ([046044e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/046044eb9e4468729b5a21ba3e860d902bb1c7f8))
* **routes/admin/access:** use faster bcrypt over scrypt ([47c7086](https://github.com/mnfClass/ydh-myydh-crud-api/commit/47c708626875df4d8fe8f79317d90ce869db0f12))
* **routes/docs/openapi:** ensure response is openapi object ([42332e0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/42332e0ac74617d9fd09ca9d1f922293b9b3b16c))
* **routes/docs:** move html and redoc out of root context ([8e18bf7](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8e18bf7fbf714dfa7512489fd1b6f6e48019f4b5))
* **routes/docs:** remove redundant html elem attributes ([c45f239](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c45f239625bf2ad3366b34765a4a9e511164e03e))
* **routes/preferences/user:** remove `await` in `Promise.all()` ([f8d88f0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f8d88f0516fecfd8b236d27278b2c0c1fba4ce69))
* **routes:** add `preValidation` hooks directly into routes ([adf3f85](https://github.com/mnfClass/ydh-myydh-crud-api/commit/adf3f85d6a6089135d682429ad91cea657f6f37a))
* **routes:** clean `accept` header conditionals ([1c87715](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1c87715f0137710eaefda29cfef387bf46ee02de))
* **routes:** move `admin/access` to `admin/access/bearer-token` ([072dafb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/072dafb49409838e4fa03fff265db673eeba98d5))
* **routes:** remove additional properties from req queries ([1c9d507](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1c9d507ebbf09cd303ddb7568ad5a2acb82d91cf))
* **server:** add error handler ([38f9f29](https://github.com/mnfClass/ydh-myydh-crud-api/commit/38f9f294907930625eff40d5b1f868adfb82f8ea))
* **server:** call reply object over raw when overwriting header ([#753](https://github.com/mnfClass/ydh-myydh-crud-api/issues/753)) ([0739fc5](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0739fc53fa44ff3cbf064ea4c28d2c86e7b57e75))
* **server:** move db and db util functions to root context ([6333aa8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6333aa8a1d8ec5550591f2a13de6800d15fa237c))
* **server:** move xml serialisation to plugin ([5272c73](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5272c73db98f06db77beb6293dd0c6321262c117))
* **server:** return instead of break in switch statement ([03556cf](https://github.com/mnfClass/ydh-myydh-crud-api/commit/03556cfad818b75c9c9250e4371cd6ae6d3c8967))
* **server:** use new hook config option for rate-limit plugin ([dab601b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/dab601b9b3435b8cfeb0005b3d538d1cb8fa4d43))
* use `type()` alias function to set content-type ([279124a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/279124a3e8afb216d7ffa74ed6a5418d6298fb7f))
* use secure-json-parse for json parsing ([2940748](https://github.com/mnfClass/ydh-myydh-crud-api/commit/29407481776955ef4677dc5241377a3ccf0051fa))


### Miscellaneous

* **.*ignore:** add pnpm lockfile ([#920](https://github.com/mnfClass/ydh-myydh-crud-api/issues/920)) ([05588f6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/05588f6b786803d342a997e607d6d693e95c6ba0))
* **.env.template:** double-quote example strings ([#686](https://github.com/mnfClass/ydh-myydh-crud-api/issues/686)) ([e77433f](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e77433fad41f60e2517c31994d1f7b761535f4f0))
* **.env.template:** remove service section ([a0d88c0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/a0d88c08630db3b4a0d01f0bdd78a75028bc50be))
* **.eslintrc:** enable `plugin:jest/style` rules ([9440d20](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9440d205e05c248cf9c4da1dccb06cd77e567599))
* **.github/codeql-config:** remove quotation marks ([196279d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/196279d9d347c5001afd72026f6eda981b8f5ac1))
* **.github/funding:** remove comments ([6d3645d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/6d3645d57b9b51e08246b2dfbe09b74e6477f1ff))
* **.github/workflows/link-check:** use `skip` input ([83af11b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/83af11b2cf25610deac78a337ec0f2299ac39d7d))
* **.github/workflows/optimise-images:** reorder event list ([399f9eb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/399f9eb520efff9e0e020aa9d3aa253200794e6d))
* **.github:** add `FUNDING.yml` ([dda4d78](https://github.com/mnfClass/ydh-myydh-crud-api/commit/dda4d7803a55b0a2f7bfd9e093fc28baea734fb0))
* **.github:** tidy files ([ccbddd6](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ccbddd66974a1596c7da57df50991662b3e00dc4))
* **.gitignore:** use latest github ignore template ([d20313d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d20313df3c321d49519bd322c413e103ba35e8c5))
* **.husky:** shell path and arg updates ([#967](https://github.com/mnfClass/ydh-myydh-crud-api/issues/967)) ([704e5c1](https://github.com/mnfClass/ydh-myydh-crud-api/commit/704e5c18bc0a2518283e84e2a240b808debd34a1))
* **.prettierignore:** add new paths from `.gitignore` ([445d9bb](https://github.com/mnfClass/ydh-myydh-crud-api/commit/445d9bb75412647b3e288abf00dce1cff147496b))
* **.vscode/extensions:** remove unmaintained extension ([8895114](https://github.com/mnfClass/ydh-myydh-crud-api/commit/8895114253258add7cce5dcbc33684e7970a41fa))
* **.vscode:** add `redhat.vscode-xml` as default xml formatter ([c595b5b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c595b5b4b371b1d0c506fc04f3a798a7d06fe30b))
* ***.ignore:** add clinicjs directory ([49cbc9a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/49cbc9afc7039ed196746e27461b2fb3a5124c13))
* auto-compress images ([#689](https://github.com/mnfClass/ydh-myydh-crud-api/issues/689)) ([e6a555a](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e6a555ade1a5f02e96b2b7620fdde8ed828d27f4))
* **bug_report:** use node 18 as placeholder for `node-version` ([447422d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/447422d1bb0cb26854b4b93f3ae67ba0bc55e700))
* **ci:** remove quotation marks from step name ([95cf20b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/95cf20bd1f75b16456c3d059b811ad49f289a230))
* compress images ([#960](https://github.com/mnfClass/ydh-myydh-crud-api/issues/960)) ([99039d2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/99039d27f496bd3da7e18ff3a122963b0ef7e6a8))
* **config:** remove redundant todo inline comment ([13745f2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/13745f2b82ea007a27766428cca9fe31c1725031))
* import destructuring ([#999](https://github.com/mnfClass/ydh-myydh-crud-api/issues/999)) ([f001fa3](https://github.com/mnfClass/ydh-myydh-crud-api/commit/f001fa30cc1691a22c3eb1d93d1bf95bf4d1330b))
* **master:** release 6.4.0 ([#644](https://github.com/mnfClass/ydh-myydh-crud-api/issues/644)) ([038f908](https://github.com/mnfClass/ydh-myydh-crud-api/commit/038f9088a2e64eae9931fc5f8708608c69b98638))
* **master:** release 6.4.1 ([#684](https://github.com/mnfClass/ydh-myydh-crud-api/issues/684)) ([c451a21](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c451a2136492ea89b84a2089771f06ad6680521f))
* **master:** release 7.0.0 ([#699](https://github.com/mnfClass/ydh-myydh-crud-api/issues/699)) ([1d8a147](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1d8a147e5389d3096a077cd5ca38068f8a09491d))
* **master:** release 7.1.0 ([#707](https://github.com/mnfClass/ydh-myydh-crud-api/issues/707)) ([627176c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/627176c021662961ca75626593fa1ad305647fcf))
* **master:** release 8.0.0 ([#737](https://github.com/mnfClass/ydh-myydh-crud-api/issues/737)) ([fbabdb9](https://github.com/mnfClass/ydh-myydh-crud-api/commit/fbabdb958e653345b4fa8f5713e8a3ce80ae3119))
* **master:** release 8.0.1 ([#754](https://github.com/mnfClass/ydh-myydh-crud-api/issues/754)) ([e17571d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e17571d810eb52987a4e36fb96dadb9ce98d1670))
* **master:** release 8.0.2 ([#782](https://github.com/mnfClass/ydh-myydh-crud-api/issues/782)) ([c552c06](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c552c067f88e00caff63191c512ca19a49a84e6e))
* **master:** release 8.0.3 ([#817](https://github.com/mnfClass/ydh-myydh-crud-api/issues/817)) ([2a94da8](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2a94da84ba4dd6369cfaa10ae79620ad75ee3d07))
* **master:** release 8.0.4 ([#837](https://github.com/mnfClass/ydh-myydh-crud-api/issues/837)) ([1d6d887](https://github.com/mnfClass/ydh-myydh-crud-api/commit/1d6d887dbd1e095e727c8479cc7bdbc8838d2df4))
* **master:** release 9.0.0 ([#857](https://github.com/mnfClass/ydh-myydh-crud-api/issues/857)) ([7ca922c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/7ca922c1d4dbe8ce0787de2b3c8a8cb06bb9f5d9))
* **master:** release 9.0.1 ([#897](https://github.com/mnfClass/ydh-myydh-crud-api/issues/897)) ([4492cda](https://github.com/mnfClass/ydh-myydh-crud-api/commit/4492cda46c7865aca44fb5c6e045662b6ca8188a))
* **master:** release 9.0.2 ([#915](https://github.com/mnfClass/ydh-myydh-crud-api/issues/915)) ([b76c9e2](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b76c9e2572ef3da8c5d3fedeef1d5274dd7178f2))
* **master:** release 9.0.3 ([#930](https://github.com/mnfClass/ydh-myydh-crud-api/issues/930)) ([9f02eca](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9f02eca40ac7e854bb040413832ee6b8ce21424e))
* **master:** release 9.0.4 ([#934](https://github.com/mnfClass/ydh-myydh-crud-api/issues/934)) ([9130cba](https://github.com/mnfClass/ydh-myydh-crud-api/commit/9130cbad5fe3764082874101d99577e2faed329a))
* **master:** release 9.0.5 ([#947](https://github.com/mnfClass/ydh-myydh-crud-api/issues/947)) ([78bae0b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/78bae0b3b0d584d7db94244f922b9aa89a40fe8f))
* **master:** release 9.0.6 ([#961](https://github.com/mnfClass/ydh-myydh-crud-api/issues/961)) ([6139537](https://github.com/mnfClass/ydh-myydh-crud-api/commit/61395371847f1683685eae2b513be962c688e9eb))
* **master:** release 9.0.7 ([#968](https://github.com/mnfClass/ydh-myydh-crud-api/issues/968)) ([aee9942](https://github.com/mnfClass/ydh-myydh-crud-api/commit/aee9942b3c9bbf20023849831aee855676139803))
* **package:** drop support for non-lts node 15 ([19beb34](https://github.com/mnfClass/ydh-myydh-crud-api/commit/19beb34b749508a432e7731fb18010cdca7b04ff))
* **plugins/db:** whitespace in switch statement ([53c18f4](https://github.com/mnfClass/ydh-myydh-crud-api/commit/53c18f48bdb1462eb6c96412a134c7371be44e21))
* **plugins/serialize-json-to-xml:** correct inline comments ([ebd77fe](https://github.com/mnfClass/ydh-myydh-crud-api/commit/ebd77fe01270167e078fba9d4663d7be1531b60f))
* **public:** add more apple-touch-icon sizes ([d0a4986](https://github.com/mnfClass/ydh-myydh-crud-api/commit/d0a4986ff98654133f077a484421fedd20a66c95))
* **public:** rename mask-icon ([092a7d0](https://github.com/mnfClass/ydh-myydh-crud-api/commit/092a7d0f8c2cb458bff83c66ee485b98a6f6f1fa))
* remove redundant `async` keywords ([2d2f001](https://github.com/mnfClass/ydh-myydh-crud-api/commit/2d2f001f286c6a41e7c2cb73c710c5eff72b607d))
* remove redundant eslint comments ([#840](https://github.com/mnfClass/ydh-myydh-crud-api/issues/840)) ([36c8d48](https://github.com/mnfClass/ydh-myydh-crud-api/commit/36c8d48814099b4fb0d30f31c2d1766965676a00))
* replace `--production` npm arg with `--omit=dev` ([0523bde](https://github.com/mnfClass/ydh-myydh-crud-api/commit/0523bdea69b3b6dda129d348e8287e1d1b6786b1))
* **routes/admin/access/bearer-token:** fix jsdoc tags ([#770](https://github.com/mnfClass/ydh-myydh-crud-api/issues/770)) ([e200d2b](https://github.com/mnfClass/ydh-myydh-crud-api/commit/e200d2ba189c29e6326237899075e7cbc710fc15))
* **routes/docs:** rename `docs/json` to `docs/openapi` ([#739](https://github.com/mnfClass/ydh-myydh-crud-api/issues/739)) ([5ffa882](https://github.com/mnfClass/ydh-myydh-crud-api/commit/5ffa8828b70af27db2fcb9ff8b21c7b7e9f85e24))
* **routes/documents/receipt:** add example for `timestamp` param ([3f50f54](https://github.com/mnfClass/ydh-myydh-crud-api/commit/3f50f540d9a93109a8f511aeba79216036460e29))
* **routes/schemas:** update `produces` and `consumes` values ([39050af](https://github.com/mnfClass/ydh-myydh-crud-api/commit/39050af0ae4f721267f0d7ed9c72103d69783b95))
* **scripts:** remove redundant gitkraken fix from prepare script ([941ac63](https://github.com/mnfClass/ydh-myydh-crud-api/commit/941ac63e85b5fcf5985069c9362f97ecca809b8c))
* **scripts:** use shorter arg aliases; remove debugging args from jest ([dbe6c7e](https://github.com/mnfClass/ydh-myydh-crud-api/commit/dbe6c7eadca160bac989f30ca2c96b7ca6342220))
* **server:** add missing asterisk to inline comment block ([4127583](https://github.com/mnfClass/ydh-myydh-crud-api/commit/41275835e5cc67ba30c1981a1be6725c789a52a2))
* **server:** fix inline comment ([025e718](https://github.com/mnfClass/ydh-myydh-crud-api/commit/025e718ece6d8a70a8e0d8cd50d24f8e36494d01))
* **server:** use optional chaining for error message logging ([b8b3b3c](https://github.com/mnfClass/ydh-myydh-crud-api/commit/b8b3b3cf5a7f81c5b5874a03de58442cedaacbba))
* sort imports alphabetically ([c0e6276](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c0e6276dee2e085f8c9abbdc3d887de2335a0def))
* use npm install alias ([c2e656d](https://github.com/mnfClass/ydh-myydh-crud-api/commit/c2e656d567d89cd509af9549be4c1675784121ab))
...
* **routes/docs/openapi:** ensure response is openapi object ([42332e0](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/42332e0ac74617d9fd09ca9d1f922293b9b3b16c))
* **routes:** remove additional properties from req queries ([1c9d507](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1c9d507ebbf09cd303ddb7568ad5a2acb82d91cf))


### Miscellaneous

* **.husky:** shell path and arg updates ([#967](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/967)) ([704e5c1](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/704e5c18bc0a2518283e84e2a240b808debd34a1))
* **.vscode/extensions:** remove unmaintained extension ([8895114](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/8895114253258add7cce5dcbc33684e7970a41fa))
* **config:** remove redundant todo inline comment ([13745f2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/13745f2b82ea007a27766428cca9fe31c1725031))


### Dependencies

* **deps-dev:** bump @commitlint/cli from 17.0.3 to 17.1.2 ([#978](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/978)) ([b305c4a](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b305c4aa40274d56e79ab86e51310bb47e49e81f))
* **deps-dev:** bump @commitlint/config-conventional ([#973](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/973)) ([7f391b2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/7f391b2d74d4436719f6b20f32aa9c31080cbab0))
* **deps-dev:** bump @faker-js/faker from 7.4.0 to 7.5.0 ([#983](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/983)) ([c17aea6](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c17aea67dbe4b52fb93a366c03cfa75e304a6dbc))
* **deps-dev:** bump eslint from 8.22.0 to 8.23.0 ([#981](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/981)) ([cef8f42](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/cef8f42009e7266b7090dc44d89f958dba71bfb5))
* **deps-dev:** bump eslint-plugin-jest from 26.8.4 to 27.0.1 ([#985](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/985)) ([df2ef43](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/df2ef4378fd5125f970dc49ee683332484e433f4))
* **deps-dev:** bump eslint-plugin-promise from 6.0.0 to 6.0.1 ([#976](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/976)) ([0e78056](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0e7805660cbdd94b63adf5d6c9093b37a2e01f64))
* **deps-dev:** bump jest from 28.1.3 to 29.0.1 ([#984](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/984)) ([28e2a23](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/28e2a23919420a22f8fee9e2594ef4c8de32bd39))
* **deps-dev:** bump jest from 29.0.1 to 29.0.2 ([#992](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/992)) ([62370c5](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/62370c50c59bdc54fc71b287d0aa220f906a9a5c))
* **deps-dev:** bump pino-pretty from 9.0.1 to 9.1.0 ([#970](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/970)) ([cf8cf03](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/cf8cf0330b32ed41aabd531746599146e781810e))
* **deps-dev:** bump playwright from 1.25.0 to 1.25.1 ([#988](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/988)) ([cf2b17f](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/cf2b17f10c47d7dd33682219ed14118f24563916))
* **deps:** bump @fastify/accepts from 4.0.0 to 4.0.1 ([#971](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/971)) ([26ba135](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/26ba13574d989f8b363667cd211f1bde55992504))
* **deps:** bump @fastify/autoload from 5.2.0 to 5.3.0 ([#982](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/982)) ([857fccf](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/857fccf0686ac9e0bbf83b3ad12071caf13b3930))
* **deps:** bump @fastify/autoload from 5.3.0 to 5.3.1 ([#990](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/990)) ([137463f](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/137463f8a8c1b2e15aa7021285d96f238aab5bf3))
* **deps:** bump @fastify/compress from 6.1.0 to 6.1.1 ([#986](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/986)) ([7d1ae20](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/7d1ae20494bd00a1f60943b9dfff36691065b05a))
* **deps:** bump @fastify/helmet from 9.1.0 to 10.0.0 ([#991](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/991)) ([fdab9b9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/fdab9b9a5982d0dda5bec71eced41f5f3754c2e3))
* **deps:** bump @fastify/rate-limit from 7.3.0 to 7.4.0 ([#975](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/975)) ([856b599](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/856b59912c7abd3ef4369d266674b632934bcf59))
* **deps:** bump @fastify/sensible from 5.1.0 to 5.1.1 ([#980](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/980)) ([0963232](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/09632326bb5c88e5ca61ae6efae4cc1b884609cb))
* **deps:** bump @fastify/swagger from 7.4.1 to 7.5.0 ([#979](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/979)) ([9e5c9e6](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/9e5c9e6a61b5e957ebb9c30ea217977781b87196))
* **deps:** bump @fastify/under-pressure from 8.0.0 to 8.1.0 ([#972](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/972)) ([55ca85b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/55ca85bd822290e429803db4db0a00e67cc29ce3))
* **deps:** bump dotenv from 16.0.1 to 16.0.2 ([#987](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/987)) ([6cdb73b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6cdb73b844d0e2c569212015126232f22ce4658e))
* **deps:** bump fastify from 4.5.2 to 4.5.3 ([#977](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/977)) ([8284f5b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/8284f5b1450aff18a2a5e412bd7c667eb23f510e))
* **deps:** bump fastify-plugin from 4.2.0 to 4.2.1 ([#989](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/989)) ([4d22ddf](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/4d22ddf020d6f02d5f6899003013777d2ae0841f))
* **deps:** bump pg from 8.7.3 to 8.8.0 ([#974](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/974)) ([a148e62](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/a148e62b388b0b2168d778a4bc2e9eba019062aa))
* **deps:** bump transistive dependencies ([f92c4ec](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f92c4ecb435c2321b9cbd7f7ffdda596eaa34e6c))
...
* check accept header is supported before parsing req body ([dbb7ee2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/dbb7ee2929b5c958ccb6df057f60ff86332b84c6))
* convert sync async handlers to sync only ([6bdec2d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6bdec2d5c538570abda92dbe151ce480bf499555))
* **plugins/serialize-json-to-xml:** consolidate if statements ([17b2d6a](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/17b2d6adfd38f28dddc1f6bf640eb2be4d13a427))
* remove redundant returns ([a3857e1](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/a3857e1cef2b596c2564e098dea2fc4fde78958e))
* **routes/admin/access/bearer-token:** remove reassignment of var ([046044e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/046044eb9e4468729b5a21ba3e860d902bb1c7f8))


### Dependencies

* **deps-dev:** bump eslint from 8.21.0 to 8.22.0 ([#958](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/958)) ([e116177](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e116177e0fdeaf7e5fa92bd701f60dcf7c601a93))
* **deps-dev:** bump eslint-plugin-jest from 26.8.2 to 26.8.3 ([#954](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/954)) ([f5eacc4](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f5eacc4d009558cd3eb04b74c2468cdcf1ed8e4a))
* **deps-dev:** bump pino-pretty from 8.1.0 to 9.0.1 ([#953](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/953)) ([20920b9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/20920b9c282f4ef796a28db4e23c9525175e8ee6))
* **deps-dev:** bump playwright from 1.24.2 to 1.25.0 ([#952](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/952)) ([87baeaf](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/87baeaff549649fb83b97473b3af39f31427a804))
* **deps:** bump @fastify/under-pressure from 7.0.0 to 8.0.0 ([#957](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/957)) ([6633d5d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6633d5d3fb3f3e410283e17d0d4e2391d2dca56b))
* **deps:** bump fastify from 4.4.0 to 4.5.0 ([#955](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/955)) ([f9c4c6f](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f9c4c6fa334d0f7a9d56f7dcc361a38a1669f87a))
* **deps:** bump fastify-plugin from 4.1.0 to 4.2.0 ([#950](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/950)) ([33c7678](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/33c76785036e487451b5af526acc560cb016d430))
* **deps:** bump mssql from 8.1.3 to 9.0.0 ([#949](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/949)) ([b18a65d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b18a65d1a54c9450dbf3527e497e6f7c63e1d3d6))
* **deps:** bump pino from 8.4.0 to 8.4.1 ([#956](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/956)) ([782cebb](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/782cebb4879942b5b762e3d68911c9b962fb5c26))
* **deps:** bump redoc from 2.0.0-rc.74 to 2.0.0-rc.75 ([#951](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/951)) ([610855e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/610855e490845b18c07e70ebc5d84f1f0fcde42a))
* **deps:** bump sub-dependencies ([#959](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/959)) ([7a777be](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/7a777be8ab69639f8e96d9175f5e51aa58950585))
...
* **.*ignore:** add pnpm lockfile ([#920](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/920)) ([05588f6](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/05588f6b786803d342a997e607d6d693e95c6ba0))
* replace `--production` npm arg with `--omit=dev` ([0523bde](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0523bdea69b3b6dda129d348e8287e1d1b6786b1))


### Dependencies

* **deps-dev:** bump eslint from 8.20.0 to 8.21.0 ([#927](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/927)) ([aa470a3](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/aa470a3d68f6626ec925f3a4fc264446787dad64))
* **deps-dev:** bump eslint-plugin-jest from 26.6.0 to 26.7.0 ([#922](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/922)) ([2750cd1](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2750cd1aeb2c7adb86bc3a0fd23849d3c1c91f44))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.3.3 to 39.3.4 ([#924](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/924)) ([54bf4ef](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/54bf4ef51d93cd2ddeb4cf4e40c8e3ca0c1c6f00))
* **deps-dev:** bump playwright from 1.24.1 to 1.24.2 ([#923](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/923)) ([32009bf](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/32009bf89952183cb9bba8a1cc65bb1b498a33c2))
* **deps:** bump @fastify/static from 6.4.1 to 6.5.0 ([#926](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/926)) ([46698b7](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/46698b741d2326a4819a4e1cfdf5165713825149))
* **deps:** bump fastify-disablecache from 3.0.0 to 3.0.1 ([#919](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/919)) ([95d02f8](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/95d02f84c744e3769668d36de7de72c29530acc4))
* **deps:** bump fastify-floc-off from 2.0.0 to 2.0.1 ([#917](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/917)) ([1b7be43](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1b7be437cd75439094b18875cecbeff28b43bfcf))
* **deps:** bump pino from 8.3.0 to 8.3.1 ([#918](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/918)) ([b71278e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b71278e774faf9e27c90092c3b5f1f555ad3615f))
* **deps:** bump redoc from 2.0.0-rc.72 to 2.0.0-rc.74 ([#921](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/921)) ([9d0afe3](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/9d0afe3359e9325d63fd0b942ceedf52ef8a4d42))
* **deps:** bump secure-json-parse from 2.4.0 to 2.5.0 ([#925](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/925)) ([8cb00ca](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/8cb00caf61b9721670aeb4f89ac7ace9f8ac3e8a))
* **deps:** bump sub-dependencies ([#928](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/928)) ([81aba30](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/81aba3011fe23aaad32319d33245c442c1d60794))
...
* **plugins/hashed-bearer-auth:** replace blocking `for()` loop ([e76b8ee](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e76b8eeace50e83c46af1a48f9130264f657a3f6))
* replace pbkdf2 with scrypt ([f565d57](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f565d570bbc5d69ec407a671a067d888c22dbbce))
* **routes/preferences/user:** remove `await` in `Promise.all()` ([f8d88f0](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f8d88f0516fecfd8b236d27278b2c0c1fba4ce69))


### Miscellaneous

* **.github/funding:** remove comments ([6d3645d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6d3645d57b9b51e08246b2dfbe09b74e6477f1ff))
* **.github:** add `FUNDING.yml` ([dda4d78](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/dda4d7803a55b0a2f7bfd9e093fc28baea734fb0))
* **.github:** tidy files ([ccbddd6](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/ccbddd66974a1596c7da57df50991662b3e00dc4))
* **.gitignore:** use latest github ignore template ([d20313d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d20313df3c321d49519bd322c413e103ba35e8c5))
* **.prettierignore:** add new paths from `.gitignore` ([445d9bb](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/445d9bb75412647b3e288abf00dce1cff147496b))
* **package:** drop support for non-lts node 15 ([19beb34](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/19beb34b749508a432e7731fb18010cdca7b04ff))
* remove redundant `async` keywords ([2d2f001](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2d2f001f286c6a41e7c2cb73c710c5eff72b607d))


### Documentation

* **readme:** grammar fixes ([fec30f2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/fec30f248086721739eb256a1814a3902f10a4c2))
* **readme:** update minimum node version required ([b95f547](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b95f547bc9f33e796554bf6f129cd76e067630d5))
* **readme:** use block quotes for notes to enable github md highlights ([3e42ebb](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/3e42ebb15b2121f69a5d34636ed88eff836e6ab3))


### Dependencies

* **deps-dev:** add missing caret range for prettier ([bc719b9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/bc719b98d2910292c186c711145aca775dfc9e68))
* **deps-dev:** bump @faker-js/faker from 7.1.0 to 7.2.0 ([#880](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/880)) ([91bf14b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/91bf14b26e9af01568fdaa4ebee2aa7d0fdd9e9c))
* **deps-dev:** bump eslint from 8.16.0 to 8.17.0 ([#871](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/871)) ([fb09c54](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/fb09c549fcac7919dd431da027741cdbc959912e))
* **deps-dev:** bump eslint from 8.17.0 to 8.18.0 ([#889](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/889)) ([cf65857](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/cf65857f49687d8bc0d78fd4360580b17aa924f5))
* **deps-dev:** bump eslint-plugin-jest from 26.4.6 to 26.5.3 ([#874](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/874)) ([e3de5a9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e3de5a93e490e1fc3f0e54ccde1ed781f2ff83a9))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.3.2 to 39.3.3 ([#888](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/888)) ([5f40050](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/5f4005062e256a81da22e6b7e296eaf0d7d4bb7c))
* **deps-dev:** bump jest from 28.1.0 to 28.1.1 ([#870](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/870)) ([b779f5e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b779f5eb3e05741dab7c5121a86c13c5adc66fb9))
* **deps-dev:** bump prettier from 2.6.2 to 2.7.1 ([#876](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/876)) ([e382617](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e382617ddea869f484c4430adc16cb0c42c3c191))
* **deps:** bump actions/dependency-review-action from 1 to 2 ([#867](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/867)) ([bf19626](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/bf19626b045380863edb60fafa7e7078e2338c13))
* **deps:** bump pino from 7.11.0 to 8.0.0 ([#859](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/859)) ([b84d800](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b84d800ae4d83c828f8d16367ddab229aa20a91b))
* **deps:** bump pino-pretty from 7.6.1 to 8.0.0 ([#858](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/858)) ([2b275b3](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2b275b3ebe8c52960cf314bf0501a5c6ed75374d))
* **deps:** bump redoc from 2.0.0-rc.71 to 2.0.0-rc.72 ([#879](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/879)) ([fdabcf1](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/fdabcf17dfd37151542020f861a06213b8519d3a))
* **deps:** bump sub-dependencies ([#890](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/890)) ([d1bdc09](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d1bdc09275fddc78c19700d678e62d1d311aeb84))
* **deps:** bump wagoid/commitlint-github-action from 4 to 5 ([#866](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/866)) ([3cf62c0](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/3cf62c096db9feccebe1097fff288b15efb21f6b))
* **deps:** move pino-pretty to dev dependencies ([c058cf7](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c058cf7e4be876a398856c2e02092914cbf17626))
...
* **routes:** timestamptz data type does not support `YYYY` patterns ([41a07c6](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/41a07c6ab95ac2a707eae93b6a4ace9e156e6e91))
...
* **deps-dev:** bump @commitlint/cli from 17.0.0 to 17.0.2 ([#846](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/846)) ([9041474](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/9041474f0d12aabc88e4ef3ee203e464ca5d5bf4))
* **deps-dev:** bump @commitlint/config-conventional ([#851](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/851)) ([d9137b8](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d9137b8aa989b2341b2926f9b37c6d57fe9ea492))
* **deps-dev:** bump @faker-js/faker from 6.3.1 to 7.1.0 ([#852](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/852)) ([07006df](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/07006df373b39c73a9cfea6f6edb796090a3e726))
* **deps-dev:** bump eslint from 8.15.0 to 8.16.0 ([#855](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/855)) ([5b93b82](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/5b93b828e503809586e5f3072c6a9907e6530359))
* **deps-dev:** bump eslint-plugin-jest from 26.2.2 to 26.4.6 ([#843](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/843)) ([5dd3f22](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/5dd3f2244b7fc43edf66e0947beb1d99802b521e))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.2.9 to 39.3.2 ([#847](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/847)) ([67c7138](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/67c7138b405deca85f6839efed4cc0a170c4ec49))
* **deps-dev:** bump playwright from 1.22.1 to 1.22.2 ([#845](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/845)) ([da88bac](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/da88bacc401dac40b0a14a278cce5e9d587d4556))
* **deps:** bump @fastify/helmet from 8.0.1 to 8.1.0 ([#848](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/848)) ([9c7656e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/9c7656e08ccc17d61cd3c198492f57b97f021c36))
* **deps:** bump @fastify/rate-limit from 6.0.0 to 6.0.1 ([#849](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/849)) ([d8e2b7f](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d8e2b7f30fb224e11185a6cd582d262731078127))
* **deps:** bump env-schema from 4.0.0 to 5.0.0 ([#854](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/854)) ([a4a82e8](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/a4a82e81f9b7ea490bdd394d8710d0afecebe5a3))
* **deps:** bump mssql from 8.1.1 to 8.1.2 ([#850](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/850)) ([2b8173c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2b8173c480aad8babb7c04680142890e3eccb0e0))
* **deps:** bump redoc from 2.0.0-rc.70 to 2.0.0-rc.71 ([#853](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/853)) ([391d161](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/391d161c0c7b1e1dacf2e46792662c6082e98cf7))
* **deps:** bump sub-dependencies ([f155618](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f1556183d02136cb4b25a77694d3effc64f1bf95))


### Miscellaneous

* **plugins/serialize-json-to-xml:** correct inline comments ([ebd77fe](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/ebd77fe01270167e078fba9d4663d7be1531b60f))
* remove redundant eslint comments ([#840](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/840)) ([36c8d48](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/36c8d48814099b4fb0d30f31c2d1766965676a00))
* **server:** fix inline comment ([025e718](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/025e718ece6d8a70a8e0d8cd50d24f8e36494d01))
...
* **ci:** use `lts/*` for node setup in lint job ([55a22eb](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/55a22eb7d265f53843922f2b0481851ea4b3cdf1))
* **ci:** use `node-version` for node matrix key ([1b1b004](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1b1b004b2027c82e3976ed659b9275a63cc3daf7))
...
* **deps-dev:** bump @commitlint/cli from 16.2.4 to 17.0.0 ([#830](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/830)) ([9bd7a6b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/9bd7a6b5b2231579f2082bd44948cb98af980661))
* **deps-dev:** bump @commitlint/config-conventional ([#831](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/831)) ([45a7727](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/45a7727b4296bb605db8713bf1795e1e4c53ffe4))
* **deps-dev:** bump autocannon from 7.8.1 to 7.9.0 ([#819](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/819)) ([c2d1af8](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c2d1af8598d51335edf129d0df1c8dcfa3971b5d))
* **deps-dev:** bump eslint from 8.14.0 to 8.15.0 ([#818](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/818)) ([0b998a2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0b998a2dbeb70441c864a95d5d8fa625eb597bc0))
* **deps-dev:** bump eslint-plugin-jest from 26.1.5 to 26.2.2 ([#825](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/825)) ([44cebd2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/44cebd22141c68bc51bacf181ed3b522348f64d6))
* **deps-dev:** bump glob from 8.0.1 to 8.0.3 ([#832](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/832)) ([cf09671](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/cf09671bed5cab7e1c6b5832b9d919d9b52d5730))
* **deps-dev:** bump husky from 7.0.4 to 8.0.1 ([#833](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/833)) ([46e0dbe](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/46e0dbeb452fbe5f8e3dd866a631756b348e399b))
* **deps-dev:** bump jest from 28.0.3 to 28.1.0 ([#824](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/824)) ([710749f](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/710749f912cb55bd5f6a2da393e8c409d693688d))
* **deps-dev:** bump playwright from 1.21.1 to 1.22.1 ([#829](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/829)) ([1767427](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1767427def5de20abed0db64d7d8884cb4a9f0fe))
* **deps:** bump @fastify/basic-auth from 3.0.1 to 3.0.2 ([#820](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/820)) ([64e4e4a](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/64e4e4a116dfc67ddb8fa0cb3f4a5724fdd54307))
* **deps:** bump @fastify/helmet from 8.0.0 to 8.0.1 ([#821](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/821)) ([61f5afb](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/61f5afb3fd26cec25014c369572fd21ef70ed64b))
* **deps:** bump @fastify/sensible from 4.0.0 to 4.1.0 ([#826](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/826)) ([2321c5e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2321c5ea76b002db2e2a4f26f51737cea8a6a1ca))
* **deps:** bump @fastify/static from 5.0.1 to 5.0.2 ([#828](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/828)) ([2f15ccd](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2f15ccdce1de5700f40309c21e0e7c3cf6ce11db))
* **deps:** bump dotenv from 16.0.0 to 16.0.1 ([#823](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/823)) ([1244eee](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1244eee3d32aeabf9505bdc37429b5c93facf548))
* **deps:** bump mssql from 8.1.0 to 8.1.1 ([#834](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/834)) ([f5ce96c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f5ce96cc1a8bfddcbf1e47b942b10e1e545477ad))
* **deps:** bump redoc from 2.0.0-rc.67 to 2.0.0-rc.70 ([#822](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/822)) ([b7454f7](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b7454f764ebea9568d69f8d72b2f2e4f62b07bf6))
* **deps:** bump sub-dependencies ([6384ee0](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6384ee06ac7bb6908611bdb1c5cd057b99186347))


### Improvements

* access `fs/promises` api via newer route ([69c90c0](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/69c90c02e25c0fbd216da6d434f9d82913621433))
...
* only trigger dependency-review on pr ([c62594c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c62594c8e8c8d8f9d9b4d74110d52ce08bbbd594))
* use shorter arg aliases for lockfile lint step ([0b2b94a](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0b2b94a2291d731381c2e67e088559e2592f96c7))
* validate that resolved url matches the package name ([925f84c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/925f84c59a1ab086e46255ea8a6e478a34794650))


### Documentation

* **readme:** add mention of insomnia example requests ([6bc9499](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6bc94998b724347a9db93991f2cd067861272401))
* **readme:** remove `db:migrate` step, now runs on start of api ([bce2bf3](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/bce2bf355311d9160416a5c84519fdfe87ad37fe))
* **readme:** remove snyk badge ([bea3ec4](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/bea3ec4426c824fe7de122b5eaa2a2a52c31415e))


### Dependencies

* **deps-dev:** bump @commitlint/cli from 16.2.3 to 16.2.4 ([#801](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/801)) ([c883f33](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c883f33b974057db218123bac6b6fef93d5b4175))
* **deps-dev:** bump @commitlint/config-conventional ([#797](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/797)) ([b0068b6](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b0068b6f7edb2383d9af6a01ec99a2951dd07db1))
* **deps-dev:** bump @faker-js/faker from 6.1.2 to 6.2.0 ([#792](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/792)) ([5679539](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/5679539cdb743e5f562c581e61f2578be0f10601))
* **deps-dev:** bump @faker-js/faker from 6.2.0 to 6.3.1 ([#804](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/804)) ([c711688](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c7116880cbdc619d8fb53caa595e1013617dea75))
* **deps-dev:** bump eslint from 8.13.0 to 8.14.0 ([#796](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/796)) ([2cf8fc7](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2cf8fc738895e58723b4e92a8fab7e2a19a5b9df))
* **deps-dev:** bump eslint-plugin-jest from 26.1.4 to 26.1.5 ([#798](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/798)) ([ce1974e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/ce1974e9af92e7f3152861de7708238d4a8035a4))
* **deps-dev:** bump eslint-plugin-jsdoc from 39.1.1 to 39.2.9 ([#790](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/790)) ([11f0e69](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/11f0e695513aa2893e5b5cfdb397f315a9d21e63))
* **deps-dev:** bump eslint-plugin-security from 1.4.0 to 1.5.0 ([#800](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/800)) ([83827d9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/83827d9a4d03245feca6d7392dcb096f1c25888a))
* **deps-dev:** bump jest from 27.5.1 to 28.0.3 ([#794](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/794)) ([d586ab7](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d586ab78d0764f094807bbfeba9afa26ccaea87e))
* **deps-dev:** bump nodemon from 2.0.15 to 2.0.16 ([#803](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/803)) ([b300561](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b3005614c285d21cb9a7aaaa9552e6b0a7d69836))
* **deps-dev:** bump playwright from 1.20.2 to 1.21.1 ([#799](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/799)) ([d36fb31](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d36fb31a08ce2dc08d0084af33f6ca9d064f1354))
* **deps:** bump @fastify/autoload from 4.0.0 to 4.0.1 ([#808](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/808)) ([164d486](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/164d4860b888360d9ab091b9be50317941d3ec9b))
* **deps:** bump @fastify/basic-auth from 3.0.0 to 3.0.1 ([#805](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/805)) ([59ba9d2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/59ba9d26a9c3b12d73688a12b8fc669e50c30fab))
* **deps:** bump @fastify/bearer-auth from 7.0.0 to 7.0.1 ([#809](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/809)) ([b2c7a99](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b2c7a99a2e462e5384006d4ee92e4cb750b95f3f))
* **deps:** bump @fastify/static from 5.0.0 to 5.0.1 ([#806](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/806)) ([0374f2d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0374f2d8c1520c83b9cd3bc07654a20001e348f8))
* **deps:** bump fastify from 3.28.0 to 3.29.0 ([#802](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/802)) ([ea40746](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/ea4074642d8f0d43f4d4c5068e9d4448e0a701f4))
* **deps:** bump github/codeql-action from 1 to 2 ([#789](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/789)) ([b2717f8](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b2717f844195247339cf64f4bd86d376fcecf5d2))
* **deps:** bump pino from 7.10.0 to 7.11.0 ([#791](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/791)) ([119ba82](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/119ba82f726fc5f2dce4ff1f91376e1e8326db10))
* **deps:** bump redoc from 2.0.0-rc.66 to 2.0.0-rc.67 ([#795](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/795)) ([760a08c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/760a08c0b691c4d5f136196c0ace6c526cb2f4ff))
* **deps:** bump sub-dependencies ([6ec9989](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/6ec9989d0a6f26c49d79d41fe7d09db796526c70))
* **deps:** bump under-pressure from 5.8.0 to 5.8.1 ([#807](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/807)) ([d71a627](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d71a627cd17a73cca8cd1980f41996b0c5b25421))
* use new `[@fastify](https://github.com/fastify)` org dependencies ([#787](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/787)) ([de8f603](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/de8f603896e66405090bdab0d362269ab18db4f7))


### Miscellaneous

* **.github/workflows/link-check:** use `skip` input ([83af11b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/83af11b2cf25610deac78a337ec0f2299ac39d7d))
* **ci:** remove quotation marks from step name ([95cf20b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/95cf20bd1f75b16456c3d059b811ad49f289a230))
* **server:** add missing asterisk to inline comment block ([4127583](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/41275835e5cc67ba30c1981a1be6725c789a52a2))
* use npm install alias ([c2e656d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/c2e656d567d89cd509af9549be4c1675784121ab))
...
* reduce workflow permissions to minimum ([e601476](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e601476154db5eb1ed0059479e4495c6213b7862))
* replace workflow-run-cleanup-action with github concurrency ([d52b642](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d52b64230de21f2eb252a27bc4a3e27b7d97ee2f))
* test migrations ([#765](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/765)) ([8fc3392](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/8fc33925206f6d45edd130d212e8892eacbf6690))


### Improvements

* **migrate:** convert callback to async ([0db24e8](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0db24e81eefba1192e2005a63c5f7315befcefd7))
* **migrate:** replace path with upath ([ea7cfbc](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/ea7cfbc9d25c4596d0ac56a61b67f518d5c5681c))
* **plugins/db:** remove case declaration ([d7501b2](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/d7501b244f968d7d5712edc6553098f105681a3c))
* **server:** call reply object over raw when overwriting header ([#753](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/753)) ([0739fc5](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0739fc53fa44ff3cbf064ea4c28d2c86e7b57e75))


### Miscellaneous

* **routes/admin/access/bearer-token:** fix jsdoc tags ([#770](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/770)) ([e200d2b](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e200d2ba189c29e6326237899075e7cbc710fc15))


### Dependencies

* **deps-dev:** bump @faker-js/faker from 6.1.1 to 6.1.2 ([#764](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/764)) ([870dd68](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/870dd689656d84297c97457fb84267fb7a56bbf9))
* **deps-dev:** bump eslint from 8.12.0 to 8.13.0 ([#776](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/776)) ([f40fe20](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f40fe201fa30fc59a9dcd3aad9e2b6f1f6056fe4))
* **deps-dev:** bump eslint-plugin-import from 2.25.4 to 2.26.0 ([#778](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/778)) ([8928ed9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/8928ed95194d5803e4f39c31838dc6f3c65d8fdf))
* **deps-dev:** bump eslint-plugin-jest from 26.1.3 to 26.1.4 ([#779](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/779)) ([0069c6d](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/0069c6d6942d2f516e2781579111b08c46a3b6ee))
* **deps-dev:** bump eslint-plugin-jsdoc from 38.1.4 to 38.1.6 ([#761](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/761)) ([7f608d7](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/7f608d78261e53adc1526fd892d6d0b233c54776))
* **deps-dev:** bump eslint-plugin-jsdoc from 38.1.6 to 39.1.1 ([#780](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/780)) ([f55f5c5](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/f55f5c5d27ba7b063c6a08f7cddc4a6ce6c20284))
* **deps-dev:** bump glob from 7.2.0 to 8.0.1 ([#772](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/772)) ([934638c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/934638cfd316d6ed434aca2ee0fd7035d35119ab))
* **deps-dev:** bump playwright from 1.20.1 to 1.20.2 ([#773](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/773)) ([b3b88bd](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b3b88bdc2aa84870a0e5174b17d2d98848225cbf))
* **deps-dev:** bump prettier from 2.6.1 to 2.6.2 ([#762](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/762)) ([bde1552](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/bde1552ad825c1e9a82b9f55b13e79e2abb4d451))
* **deps:** bump actions/upload-artifact from 2 to 3 ([#771](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/771)) ([793d028](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/793d028ce8fb5a1d87d9f15a03b5dceb255e600b))
* **deps:** bump fastify from 3.27.4 to 3.28.0 ([#763](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/763)) ([1c3c667](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1c3c6675fb47c90d516f6683cf2ce58f071a8e1a))
* **deps:** bump fastify-floc-off from 1.0.5 to 1.0.6 ([811410c](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/811410c3445cd0a44ea4a0104dcc256f6bb2b4e4))
* **deps:** bump hadolint/hadolint-action from 2.0.0 to 2.1.0 ([#755](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/755)) ([e067f80](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/e067f8031f3fb00860565dfbd4e506f99764db6b))
* **deps:** bump moment from 2.29.1 to 2.29.2 ([#768](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/768)) ([ae97d2e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/ae97d2eda6b8bc0ea250762b3d33f34547f8e600))
* **deps:** bump mssql from 8.0.2 to 8.1.0 ([#774](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/774)) ([1ba46cd](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/1ba46cd9c0f57c744711a1a77211cbf1724f21e6))
* **deps:** bump pino from 7.9.2 to 7.10.0 ([#777](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/777)) ([2183c2e](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/2183c2e4d726f0b97acaa10186b06b870ca03f71))
* **deps:** bump pino-pretty from 7.6.0 to 7.6.1 ([#775](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/775)) ([7e00ceb](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/7e00ceb31f10f1ab85596b330f76671f45bb6e7a))
* **deps:** bump redoc from 2.0.0-rc.65 to 2.0.0-rc.66 ([dc406f9](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/dc406f90aa0fe775de9623185052369285d15b29))
* **docker:** install production deps only ([#769](https://github.com/Fdawgs/ydh-myydh-crud-api/issues/769)) ([b2d4367](https://github.com/Fdawgs/ydh-myydh-crud-api/commit/b2d43671205daa3615eea035a08170941777612c))
